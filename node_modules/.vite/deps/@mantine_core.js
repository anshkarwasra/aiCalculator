...
function getRefProp(element) {
  var _a;
  const version = import_react74.default.version;
  if (typeof import_react74.default.version !== "string") {
...
var MantineContext = (0, import_react75.createContext)(null);
function useMantineContext() {
  const ctx = (0, import_react75.useContext)(MantineContext);
  if (!ctx) {
...
// node_modules/@mantine/core/esm/core/MantineProvider/MantineThemeProvider/MantineThemeProvider.mjs
var MantineThemeContext = (0, import_react79.createContext)(null);
var useSafeMantineTheme = () => (0, import_react79.useContext)(MantineThemeContext) || DEFAULT_THEME;
function useMantineTheme() {
  const ctx = (0, import_react79.useContext)(MantineThemeContext);
  if (!ctx) {
    throw new Error(
...
function MantineThemeProvider({
  ...
  const mergedTheme = (0, import_react79.useMemo)(
...
function useProviderColorScheme({
  ...
  const media = (0, import_react86.useRef)();
  const [value, setValue] = (0, import_react86.useState)(() => manager.get(defaultColorScheme));
  const colorSchemeValue = forceColorScheme || value;
  const setColorScheme = (0, import_react86.useCallback)(
    (colorScheme) => {
      if (!forceColorScheme) {
  ...
  const clearColorScheme = (0, import_react86.useCallback)(() => {
...
function resolveVars({
  ...
  var _a;
  return (_a = mergeVars([
    headless ? {} : varsResolver88 == null ? void 0 : varsResolver88(theme, props, stylesCtx),
    ...themeName.map((name) => {
      var _a2, _b, _c;
...
function getStyle({
  ...
  return {
    ...
    ...resolveVars({ theme, props, stylesCtx, vars, varsResolver: varsResolver88, selector, themeName, headless }),
...
function useMantineColorScheme({ keepTransitions } = {}) {
  const clearStylesRef = (0, import_react92.useRef)();
  const timeoutRef = (0, import_react92.useRef)();
  const ctx = (0, import_react92.useContext)(MantineContext);
  const nonce = useMantineStyleNonce();
  const nonceValue = (0, import_react92.useRef)(nonce == null ? void 0 : nonce());
  if (!ctx) {
    throw new Error("[@mantine/core] MantineProvider was not found in tree");
  }
  ...
  const toggleColorScheme = (0, import_react92.useCallback)(
...
function useRandomClassName() {
  const id = (0, import_react104.useId)().replace(/:/g, "");
  return `__m__-${id}`;
}
...
// node_modules/@mantine/core/esm/core/Box/Box.mjs
var _Box = (0, import_react105.forwardRef)(
  ({
    component,
    style,
    __vars,
...
function getWithProps(Component) {
  ...
  return (fixedProps) => {
    const Extended = (0, import_react106.forwardRef)((props, ref) => (0, import_jsx_runtime32.jsx)(_Component, { ...fixedProps, ...props, ref }));
...
function factory(ui) {
  ...
  Component.withProps = (fixedProps) => {
    const Extended = (0, import_react106.forwardRef)((props, ref) => (0, import_jsx_runtime32.jsx)(Component, { ...fixedProps, ...props, ref }));
...
var DirectionContext = (0, import_react108.createContext)({
  dir: "ltr",
  toggleDirection: () => {
  },
  setDirection: () => {
...
function useDirection() {
  return (0, import_react108.useContext)(DirectionContext);
}
function DirectionProvider({
  ...
  const [dir, setDir] = (0, import_react108.useState)(initialDirection);
...
function useCollapse({
  ...
  const [styles, setStylesRaw] = (0, import_react109.useState)(opened ? {} : collapsedStyles);
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaCorner/ScrollAreaCorner.mjs
var Corner = (0, import_react112.forwardRef)((props, ref) => {
  const { style, ...others } = props;
  const ctx = useScrollAreaContext();
  const [width, setWidth] = (0, import_react112.useState)(0);
  const [height, setHeight] = (0, import_react112.useState)(0);
...
var ScrollAreaCorner = (0, import_react112.forwardRef)((props, ref) => {
  const ctx = useScrollAreaContext();
...
var ScrollAreaRoot = (0, import_react113.forwardRef)((_props, ref) => {
  const props = useProps("ScrollAreaRoot", defaultProps2, _props);
  const { type, scrollHideDelay, scrollbars, ...others } = props;
  const [scrollArea, setScrollArea] = (0, import_react113.useState)(null);
  const [viewport, setViewport] = (0, import_react113.useState)(null);
  const [content, setContent] = (0, import_react113.useState)(null);
  const [scrollbarX, setScrollbarX] = (0, import_react113.useState)(null);
  const [scrollbarY, setScrollbarY] = (0, import_react113.useState)(null);
  const [cornerWidth, setCornerWidth] = (0, import_react113.useState)(0);
  const [cornerHeight, setCornerHeight] = (0, import_react113.useState)(0);
  const [scrollbarXEnabled, setScrollbarXEnabled] = (0, import_react113.useState)(false);
  const [scrollbarYEnabled, setScrollbarYEnabled] = (0, import_react113.useState)(false);
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/Scrollbar.mjs
var Scrollbar = (0, import_react115.forwardRef)((props, forwardedRef) => {
  const {
    sizes: sizes2,
    hasThumb,
    onThumbChange,
  ...
  const [scrollbar, setScrollbar] = (0, import_react115.useState)(null);
  const composeRefs = useMergedRef(forwardedRef, (node) => setScrollbar(node));
  const rectRef = (0, import_react115.useRef)(null);
  const prevWebkitUserSelectRef = (0, import_react115.useRef)("");
  ...
  (0, import_react115.useEffect)(handleThumbPositionChange, [sizes2, handleThumbPositionChange]);
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollbarX.mjs
var ScrollAreaScrollbarX = (0, import_react116.forwardRef)(
  (props, forwardedRef) => {
...
var ScrollAreaScrollbarY = (0, import_react117.forwardRef)(
  (props, forwardedRef) => {
    const { sizes: sizes2, onSizesChange, style, ...others } = props;
    const context = useScrollAreaContext();
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbarVisible.mjs
var ScrollAreaScrollbarVisible = (0, import_react118.forwardRef)((props, forwardedRef) => {
  const { orientation = "vertical", ...scrollbarProps } = props;
  const { dir } = useDirection();
  const context = useScrollAreaContext();
  const thumbRef = (0, import_react118.useRef)(null);
  const pointerOffsetRef = (0, import_react118.useRef)(0);
  const [sizes2, setSizes] = (0, import_react118.useState)({
    content: 0,
    viewport: 0,
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbarAuto.mjs
var ScrollAreaScrollbarAuto = (0, import_react119.forwardRef)(
  (props, ref) => {
    const context = useScrollAreaContext();
...
var ScrollAreaScrollbarHover = (0, import_react120.forwardRef)(
  (props, ref) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
...
var ScrollAreaScrollbarScroll = (0, import_react121.forwardRef)(
  (props, red) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
    const isHorizontal = props.orientation === "horizontal";
    const [state, setState] = (0, import_react121.useState)("hidden");
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaScrollbar/ScrollAreaScrollbar.mjs
var ScrollAreaScrollbar = (0, import_react122.forwardRef)(
  (props, forwardedRef) => {
    const { forceMount, ...scrollbarProps } = props;
    const context = useScrollAreaContext();
...
// node_modules/@mantine/core/esm/components/ScrollArea/ScrollAreaThumb/ScrollAreaThumb.mjs
var Thumb = (0, import_react123.forwardRef)((props, forwardedRef) => {
  const { style, ...others } = props;
  const scrollAreaContext = useScrollAreaContext();
  const scrollbarContext = useScrollbarContext();
  const { onThumbPositionChange } = scrollbarContext;
  const composedRef = useMergedRef(forwardedRef, (node) => scrollbarContext.onThumbChange(node));
  const removeUnlinkedScrollListenerRef = (0, import_react123.useRef)();
...
var ScrollAreaThumb = (0, import_react123.forwardRef)(
  (props, forwardedRef) => {
...
var ScrollAreaViewport = (0, import_react124.forwardRef)(
...
var ScrollArea = factory((_props, ref) => {
  ...
  const [scrollbarHovered, setScrollbarHovered] = (0, import_react125.useState)(false);
...
var index = typeof document !== "undefined" ? import_react129.useLayoutEffect : import_react129.useEffect;
...
var index2 = typeof document !== "undefined" ? import_react130.useLayoutEffect : import_react130.useEffect;
...
function useLatestRef2(value) {
  const ref = (0, import_react130.useRef)(value);
  index2(() => {
    ref.current = value;
  });
  return ref;
...
// node_modules/@mantine/core/esm/components/Floating/FloatingArrow/FloatingArrow.mjs
var FloatingArrow3 = (0, import_react131.forwardRef)(
  ({
    position,
    arrowSize,
    arrowOffset,
...
function FocusTrap({
  ...
  return (0, import_react133.cloneElement)(children, { [refProp]: ref });
}
...
var defaultProps7 = {};
var Portal = (0, import_react134.forwardRef)((props, ref) => {
  const { children, target, ...others } = useProps("Portal", defaultProps7, props);
  const [mounted, setMounted] = (0, import_react134.useState)(false);
  const nodeRef = (0, import_react134.useRef)(null);
  useIsomorphicEffect(() => {
    setMounted(true);
...
function useTransition({
  ...
  const shouldReduceMotion = useReducedMotion();
  const reduceMotion = theme.respectReducedMotion ? shouldReduceMotion : false;
  const [transitionDuration, setTransitionDuration] = (0, import_react136.useState)(reduceMotion ? 0 : duration);
  const [transitionStatus, setStatus] = (0, import_react136.useState)(mounted ? "entered" : "exited");
  const transitionTimeoutRef = (0, import_react136.useRef)(-1);
  const delayTimeoutRef = (0, import_react136.useRef)(-1);
  const rafRef = (0, import_react136.useRef)(-1);
...
var PopoverTarget = factory((props, ref) => {
  ...
  return (0, import_react139.cloneElement)(children, {
    ...forwardedProps,
    ...accessibleProps,
    ...ctx.targetProps,
...
function useFloatingAutoUpdate({
  ...
  const [delayedUpdate, setDelayedUpdate] = (0, import_react140.useState)(0);
...
function usePopover(options) {
  ...
  const previouslyOpened = (0, import_react142.useRef)(_opened);
  const onClose = () => {
    if (_opened) {
      setOpened(false);
    }
...
function Popover(_props) {
  ...
  const arrowRef = (0, import_react144.useRef)(null);
  const [targetNode, setTargetNode] = (0, import_react144.useState)(null);
  const [dropdownNode, setDropdownNode] = (0, import_react144.useState)(null);
  const { dir } = useDirection();
  const uid = useId(id);
  ...
  const reference = (0, import_react144.useCallback)(
    (node) => {
      setTargetNode(node);
  ...
  const floating = (0, import_react144.useCallback)(
    (node) => {
  ...
  const onExited = (0, import_react144.useCallback)(() => {
    var _a2;
  ...
  const onEntered = (0, import_react144.useCallback)(() => {
    var _a2;
...
// node_modules/@mantine/core/esm/components/Loader/loaders/Bars.mjs
var Bars = (0, import_react146.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime65.jsxs)(Box, { component: "span", className: clsx_default(classes6.barsLoader, className), ...others, ref, children: [
...
var Dots = (0, import_react147.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime66.jsxs)(Box, { component: "span", className: clsx_default(classes6.dotsLoader, className), ...others, ref, children: [
...
var Oval = (0, import_react148.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime67.jsx)(Box, { component: "span", className: clsx_default(classes6.ovalLoader, className), ...others, ref }));
...
function useLockScroll({ opened, transitionDuration }) {
  ...
  const timeout = (0, import_react158.useRef)();
...
var InputWrapper = factory((_props, ref) => {
  ...
  const _input = (0, import_jsx_runtime89.jsx)(import_react174.Fragment, { children: inputContainer(children) }, "input");
...
function useInputProps(component, defaultProps182, _props) {
  const props = useProps(component, defaultProps182, _props);
  const {
    label,
    description,
    error: error2,
...
function useFloatingIndicator({
  ...
  const transitionTimeout = (0, import_react179.useRef)();
  ...
  const targetResizeObserver = (0, import_react179.useRef)();
  const parentResizeObserver = (0, import_react179.useRef)();
...
var varsResolver20 = createVarsResolver((_, { size: size4, thumbSize }) => ({
  root: {
...
var AngleSlider = factory((_props, ref) => {
  const props = useProps("AngleSlider", defaultProps34, _props);
  const {
    classNames,
    className,
    style,
  ...
  const handleMouseMove = (0, import_react192.useCallback)((event) => {
    update(event);
  }, []);
  const handleMouseUp = (0, import_react192.useCallback)((event) => {
    update(event, true);
    endTracking();
  }, []);
  const handleTouchMove = (0, import_react192.useCallback)((event) => {
    event.preventDefault();
    update(event.touches[0]);
  }, []);
  const handleTouchEnd = (0, import_react192.useCallback)((event) => {
  ...
  const marksItems = marks == null ? void 0 : marks.map((mark, index5) => (0, import_react192.createElement)(
    "div",
    {
  ...
  return (0, import_jsx_runtime107.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        marksItems && marksItems.length > 0 && (0, import_jsx_runtime107.jsx)("div", { ...getStyles2("marks"), children: marksItems }),
        withLabel && (0, import_jsx_runtime107.jsx)("div", { ...getStyles2("label"), children: typeof formatLabel === "function" ? formatLabel(_value) : _value }),
        ...
        (0, import_jsx_runtime107.jsx)("input", { type: "hidden", name, value: _value, ...hiddenInputProps })
      ]
    }
  );
});
...
function AppShellMediaStyles({
  ...
  return (0, import_jsx_runtime120.jsx)(InlineStyles, { media, styles: baseStyles, selector: ctx.cssVariablesSelector });
}
...
function useResizing({ transitionDuration, disabled }) {
  ...
  const resizingTimeout = (0, import_react208.useRef)();
  const disabledTimeout = (0, import_react208.useRef)();
...
var AppShell = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime123.jsxs)(AppShellProvider, { value: { getStyles: getStyles2, withBorder, zIndex, disabled, offsetScrollbars }, children: [
...
// node_modules/@mantine/core/esm/components/AspectRatio/AspectRatio.mjs
var defaultProps42 = {};
var varsResolver22 = createVarsResolver((_, { ratio }) => ({
  root: {
    "--ar-ratio": ratio == null ? void 0 : ratio.toString()
  }
}));
var AspectRatio = factory((_props, ref) => {
  const props = useProps("AspectRatio", defaultProps42, _props);
  ...
  return (0, import_jsx_runtime124.jsx)(Box, { ref, ...getStyles2("root"), ...others });
});
...
var varsResolver23 = createVarsResolver((_, { size: size4 }) => ({
  chevron: {
    "--combobox-chevron-size": getSize(size4, "combobox-chevron-size")
  }
}));
var ComboboxChevron = factory((_props, ref) => {
  const props = useProps("ComboboxChevron", defaultProps43, _props);
...
var ComboboxClearButton = (0, import_react213.forwardRef)(
  ({ size: size4, onMouseDown, onClick, onClear, ...others }, ref) => (0, import_jsx_runtime127.jsx)(
    CloseButton,
    {
      ref,
      size: size4 || "sm",
...
var ComboboxDropdownTarget = factory((props, ref) => {
  const { children, refProp } = useProps("ComboboxDropdownTarget", defaultProps45, props);
  useComboboxContext();
  if (!isElement(children)) {
    throw new Error(
  ...
  return (0, import_jsx_runtime129.jsx)(Popover.Target, { ref, refProp, children });
});
...
var ComboboxEventsTarget = factory((props, ref) => {
  const {
    ...
    autoComplete,
    ...others
  } = useProps("ComboboxEventsTarget", defaultProps47, props);
  if (!isElement(children)) {
    throw new Error(
...
var ComboboxGroup = factory((props, ref) => {
  ...
  return (0, import_jsx_runtime133.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        label && (0, import_jsx_runtime133.jsx)("div", { ...ctx.getStyles("groupLabel", { classNames, styles }), children: label }),
        children
      ]
    }
  );
...
var ComboboxOption = factory((_props, ref) => {
  const props = useProps("ComboboxOption", defaultProps51, _props);
  const {
    classNames,
    className,
    style,
...
var ComboboxOptions = factory((_props, ref) => {
  const props = useProps("ComboboxOptions", defaultProps52, _props);
...
var ComboboxSearch = factory((_props, ref) => {
  const props = useProps("ComboboxSearch", defaultProps53, _props);
  const {
    classNames,
    styles,
    unstyled,
...
var ComboboxTarget = factory((props, ref) => {
  const {
    ...
    autoComplete,
    ...others
  } = useProps("ComboboxTarget", defaultProps54, props);
  if (!isElement(children)) {
    throw new Error(
  ...
  return (0, import_jsx_runtime139.jsx)(Popover.Target, { ref: useMergedRef(ref, ctx.store.targetRef), children: clonedElement });
});
...
var varsResolver24 = createVarsResolver((_, { size: size4, dropdownPadding }) => ({
  options: {
...
function Combobox(_props) {
  const props = useProps("Combobox", defaultProps55, _props);
  const {
    classNames,
    styles,
    unstyled,
  ...
  return (0, import_jsx_runtime140.jsx)(
    ComboboxProvider,
    {
      ...
      children: (0, import_jsx_runtime140.jsx)(
        Popover,
        {
  ...
  ({
    ...
    return (0, import_jsx_runtime141.jsx)(
      Box,
      {
        ...
        size: size4,
        ...others,
        children: (0, import_jsx_runtime141.jsxs)(
          Box,
          {
            ...
            children: [
              children,
              (0, import_jsx_runtime141.jsxs)("div", { ...getStyles2("labelWrapper"), "data-disabled": disabled || void 0, children: [
                label && (0, import_jsx_runtime141.jsx)(
                  Box,
                  {
                    component: labelElement,
                ...
                description && (0, import_jsx_runtime141.jsx)(Input.Description, { size: size4, __inheritStyles: false, ...getStyles2("description"), children: description }),
                error2 && typeof error2 !== "boolean" && (0, import_jsx_runtime141.jsx)(Input.Error, { size: size4, __inheritStyles: false, ...getStyles2("error"), children: error2 })
              ] })
            ]
          }
        )
...
var varsResolver25 = createVarsResolver((_, { radius }) => ({
  card: {
    "--card-radius": getRadius(radius)
  }
}));
var CheckboxCard = factory((_props, ref) => {
  const props = useProps("CheckboxCard", defaultProps56, _props);
  const {
    classNames,
    className,
    style,
  ...
  const _checked = typeof checked === "boolean" ? checked : (ctx == null ? void 0 : ctx.value.includes(value || "")) || void 0;
  const [_value, setValue] = useUncontrolled({
    value: _checked,
  ...
  return (0, import_jsx_runtime143.jsx)(CheckboxCardProvider, { value: { checked: _value }, children: (0, import_jsx_runtime143.jsx)(
    UnstyledButton,
    {
      ref,
...
function InputsGroupFieldset({ children, role }) {
  const ctx = useInputWrapperContext();
  if (!ctx) {
    return (0, import_jsx_runtime144.jsx)(import_jsx_runtime144.Fragment, { children });
  }
  return (0, import_jsx_runtime144.jsx)("div", { role, "aria-labelledby": ctx.labelId, "aria-describedby": ctx.describedBy, children });
}

// node_modules/@mantine/core/esm/components/Checkbox/CheckboxGroup/CheckboxGroup.mjs
var defaultProps57 = {};
var CheckboxGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size4, wrapperProps, children, readOnly, ...others } = useProps("CheckboxGroup", defaultProps57, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [],
  ...
  return (0, import_jsx_runtime145.jsx)(CheckboxGroupProvider, { value: { value: _value, onChange: handleChange, size: size4 }, children: (0, import_jsx_runtime145.jsx)(
    Input.Wrapper,
    {
      size: size4,
      ref,
      ...
      children: (0, import_jsx_runtime145.jsx)(InputsGroupFieldset, { role: "group", children })
    }
  ) });
});
  ...
  if (indeterminate) {
    return (0, import_jsx_runtime146.jsx)(
      "svg",
      {
        ...
        "aria-hidden": true,
        ...others,
        children: (0, import_jsx_runtime146.jsx)("rect", { width: "32", height: "6", fill: "currentColor", rx: "3" })
      }
    );
  }
  return (0, import_jsx_runtime146.jsx)(CheckIcon, { ...others });
}
...
var CheckboxIndicator = factory((_props, ref) => {
  const props = useProps("CheckboxIndicator", defaultProps58, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime147.jsx)(
    Box,
    {
      ...
      ...others,
      children: (0, import_jsx_runtime147.jsx)(Icon, { indeterminate, ...getStyles2("icon") })
    }
  );
});
...
var Checkbox = factory((_props, ref) => {
  const props = useProps("Checkbox", defaultProps59, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime148.jsx)(
    InlineInput,
    {
      ...
      ...styleProps,
      ...wrapperProps,
      children: (0, import_jsx_runtime148.jsxs)(Box, { ...getStyles2("inner"), mod: { "data-label-position": labelPosition }, children: [
        ...
        (0, import_jsx_runtime148.jsx)(Icon, { indeterminate, ...getStyles2("icon") })
      ] })
    }
  );
});
...
function Option({
  ...
  if (!isOptionsGroup(data)) {
    ...
    const check = withCheckIcon && checked && (0, import_jsx_runtime149.jsx)(CheckIcon, { className: classes23.optionsDropdownCheckIcon });
    const defaultContent = (0, import_jsx_runtime149.jsxs)(import_jsx_runtime149.Fragment, { children: [
      checkIconPosition === "left" && check,
      (0, import_jsx_runtime149.jsx)("span", { children: data.label }),
  ...
  const options = data.items.map((item) => (0, import_jsx_runtime149.jsx)(
    Option,
    {
      data: item,
      value,
  ...
  return (0, import_jsx_runtime149.jsx)(Combobox.Group, { label: data.group, children: options });
}
function OptionsDropdown({
  ...
  const options = filteredData.map((item) => (0, import_jsx_runtime149.jsx)(
    Option,
    {
      data: item,
      withCheckIcon,
  ...
  return (0, import_jsx_runtime149.jsx)(Combobox.Dropdown, { hidden: hidden2 || hiddenWhenEmpty && isEmpty, children: (0, import_jsx_runtime149.jsxs)(Combobox.Options, { labelledBy: labelId, "aria-label": ariaLabel, children: [
    withScrollArea ? (0, import_jsx_runtime149.jsx)(
      ScrollArea.Autosize,
      {
    ...
    isEmpty && nothingFoundMessage && (0, import_jsx_runtime149.jsx)(Combobox.Empty, { children: nothingFoundMessage })
  ] }) });
}
...
var Autocomplete = factory((_props, ref) => {
  const props = useProps("Autocomplete", defaultProps60, _props);
  const {
    classNames,
    styles,
    unstyled,
  ...
  return (0, import_jsx_runtime150.jsxs)(
    Combobox,
    {
      ...
      ...comboboxProps,
      children: [
        (0, import_jsx_runtime150.jsx)(Combobox.Target, { autoComplete, children: (0, import_jsx_runtime150.jsx)(
          InputBase,
          {
            ref,
            ...others,
...
// node_modules/@mantine/core/esm/components/Avatar/AvatarGroup/AvatarGroup.mjs
var defaultProps61 = {};
var varsResolver28 = createVarsResolver((_, { spacing }) => ({
  group: {
    "--ag-spacing": getSpacing(spacing)
  }
}));
var AvatarGroup = factory((_props, ref) => {
  const props = useProps("AvatarGroup", defaultProps61, _props);
  ...
  return (0, import_jsx_runtime151.jsx)(AvatarGroupProvider, { value: true, children: (0, import_jsx_runtime151.jsx)(Box, { ref, ...getStyles2("group"), ...others }) });
});
...
var Avatar = polymorphicFactory((_props, ref) => {
  const props = useProps("Avatar", defaultProps62, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime153.jsx)(
    Box,
    {
      ...
      ref,
      ...others,
      children: error2 ? (0, import_jsx_runtime153.jsx)("span", { ...getStyles2("placeholder"), title: alt, children: children || typeof name === "string" && getInitials(name) || (0, import_jsx_runtime153.jsx)(AvatarPlaceholderIcon, {}) }) : (0, import_jsx_runtime153.jsx)(
        "img",
        {
          ...imageProps,
          ...getStyles2("image"),
...
// node_modules/@mantine/core/esm/components/BackgroundImage/BackgroundImage.mjs
var defaultProps63 = {};
var varsResolver30 = createVarsResolver((_, { radius }) => ({
  root: { "--bi-radius": radius === void 0 ? void 0 : getRadius(radius) }
}));
var BackgroundImage = polymorphicFactory((_props, ref) => {
  const props = useProps("BackgroundImage", defaultProps63, _props);
...
var Badge = polymorphicFactory((_props, ref) => {
  const props = useProps("Badge", defaultProps64, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime155.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        leftSection && (0, import_jsx_runtime155.jsx)("span", { ...getStyles2("section"), "data-position": "left", children: leftSection }),
        (0, import_jsx_runtime155.jsx)("span", { ...getStyles2("label"), children }),
        rightSection && (0, import_jsx_runtime155.jsx)("span", { ...getStyles2("section"), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var varsResolver32 = createVarsResolver((theme, { color, iconSize, radius }) => {
...
var Blockquote = factory((_props, ref) => {
  const props = useProps("Blockquote", defaultProps65, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime156.jsxs)(Box, { component: "blockquote", ref, ...getStyles2("root"), ...others, children: [
    icon && (0, import_jsx_runtime156.jsx)("span", { ...getStyles2("icon"), children: icon }),
    children,
    cite && (0, import_jsx_runtime156.jsx)("cite", { ...getStyles2("cite"), children: cite })
  ] });
});
...
var varsResolver33 = createVarsResolver((_, { separatorMargin }) => ({
  root: {
    "--bc-separator-margin": getSpacing(separatorMargin)
  }
}));
var Breadcrumbs = factory((_props, ref) => {
  const props = useProps("Breadcrumbs", defaultProps66, _props);
  const {
    classNames,
    className,
    style,
  ...
  const items = import_react244.Children.toArray(children).reduce((acc, child, index5, array) => {
    var _a;
    const item = isElement(child) ? (0, import_react244.cloneElement)(child, {
      ...
      key: index5
    }) : (0, import_react244.createElement)("div", { ...getStyles2("breadcrumb"), key: index5 }, child);
    acc.push(item);
    if (index5 !== array.length - 1) {
      acc.push(
        (0, import_react244.createElement)(Box, { ...getStyles2("separator"), key: `separator-${index5}` }, separator)
      );
    }
    return acc;
  }, []);
  return (0, import_jsx_runtime157.jsx)(Box, { ref, ...getStyles2("root"), ...others, children: items });
});
...
var Burger = factory((_props, ref) => {
  const props = useProps("Burger", defaultProps67, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime158.jsxs)(UnstyledButton, { ...getStyles2("root"), ref, ...others, children: [
    (0, import_jsx_runtime158.jsx)(Box, { mod: ["reduce-motion", { opened }], ...getStyles2("burger") }),
    children
  ] });
});
...
var classes34 = { "root": "m_77c9d27d", "inner": "m_80f1301b", "label": "m_811560b9", "section": "m_a74036a", "loader": "m_a25b86ee", "group": "m_80d6d844" };

// node_modules/@mantine/core/esm/components/Button/ButtonGroup/ButtonGroup.mjs
var defaultProps68 = {
  orientation: "horizontal"
};
var varsResolver35 = createVarsResolver((_, { borderWidth }) => ({
  group: { "--button-border-width": rem(borderWidth) }
}));
var ButtonGroup = factory((_props, ref) => {
  const props = useProps("ButtonGroup", defaultProps68, _props);
  const {
    className,
    style,
    classNames,
    ...
    mod,
    ...others
  } = useProps("ButtonGroup", defaultProps68, _props);
  const getStyles2 = useStyles({
    name: "ButtonGroup",
    props,
    classes: classes34,
...
var Button = polymorphicFactory((_props, ref) => {
  const props = useProps("Button", defaultProps69, _props);
  const {
    style,
    vars,
    className,
  ...
  return (0, import_jsx_runtime160.jsxs)(
    UnstyledButton,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime160.jsx)(Transition, { mounted: !!loading, transition: loaderTransition, duration: 150, children: (transitionStyles) => (0, import_jsx_runtime160.jsx)(Box, { component: "span", ...getStyles2("loader", { style: transitionStyles }), "aria-hidden": true, children: (0, import_jsx_runtime160.jsx)(
          Loader,
          {
        ...
        (0, import_jsx_runtime160.jsxs)("span", { ...getStyles2("inner"), children: [
          leftSection && (0, import_jsx_runtime160.jsx)(Box, { component: "span", ...getStyles2("section"), mod: { position: "left" }, children: leftSection }),
          (0, import_jsx_runtime160.jsx)(Box, { component: "span", mod: { loading }, ...getStyles2("label"), children }),
          rightSection && (0, import_jsx_runtime160.jsx)(Box, { component: "span", ...getStyles2("section"), mod: { position: "right" }, children: rightSection })
        ] })
      ]
    }
  );
...
var CardSection = polymorphicFactory((_props, ref) => {
  const props = useProps("CardSection", defaultProps70, _props);
...
// node_modules/@mantine/core/esm/components/Card/Card.mjs
var defaultProps71 = {};
var varsResolver37 = createVarsResolver((_, { padding }) => ({
  root: {
    "--card-padding": getSpacing(padding)
  }
}));
var Card = polymorphicFactory((_props, ref) => {
  const props = useProps("Card", defaultProps71, _props);
  ...
  return (0, import_jsx_runtime163.jsx)(CardProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime163.jsx)(Paper, { ref, unstyled, ...getStyles2("root"), ...others, children: content }) });
});
...
var Center = polymorphicFactory((_props, ref) => {
  const props = useProps("Center", defaultProps72, _props);
  ...
  return (0, import_jsx_runtime164.jsx)(Box, { ref, mod: [{ inline: inline4 }, mod], ...getStyles2("root"), ...others });
});
...
function ChipGroup(props) {
  ...
  return (0, import_jsx_runtime166.jsx)(ChipGroupProvider, { value: { isChipSelected, onChange: handleChange, multiple }, children });
}
...
var Chip = factory((_props, ref) => {
  const props = useProps("Chip", defaultProps74, _props);
  const {
    classNames,
    className,
    style,
      ...
      children: [
        ...
        (0, import_jsx_runtime167.jsxs)(
          "label",
          {
            ...
            children: [
              _checked && (0, import_jsx_runtime167.jsx)("span", { ...getStyles2("iconWrapper"), children: icon || (0, import_jsx_runtime167.jsx)(CheckIcon, { ...getStyles2("checkIcon") }) }),
              (0, import_jsx_runtime167.jsx)("span", { children })
            ]
          }
        )
      ]
...
var Code = factory((_props, ref) => {
  const props = useProps("Code", defaultProps75, _props);
  const {
    classNames,
    className,
    style,
...
var varsResolver40 = createVarsResolver((_, { radius, size: size4 }) => ({
  root: {
...
var ColorSwatch = polymorphicFactory((_props, ref) => {
  const props = useProps("ColorSwatch", defaultProps76, _props);
  const {
    classNames,
    className,
    style,
    ...
    variant,
    ...others
  } = useProps("ColorSwatch", defaultProps76, props);
  const getStyles2 = useStyles({
    name: "ColorSwatch",
    props,
    classes: classes39,
  ...
  return (0, import_jsx_runtime169.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime169.jsx)("span", { ...getStyles2("alphaOverlay") }),
        withShadow && (0, import_jsx_runtime169.jsx)("span", { ...getStyles2("shadowOverlay") }),
        (0, import_jsx_runtime169.jsx)("span", { ...getStyles2("colorOverlay", { style: { backgroundColor: color } }) }),
        (0, import_jsx_runtime169.jsx)("span", { ...getStyles2("childrenOverlay"), children })
      ]
    }
  );
});
...
var Thumb2 = (0, import_react258.forwardRef)(({ position, ...others }, ref) => (0, import_jsx_runtime171.jsx)(
  Box,
  {
    ref,
    __vars: {
...
var ColorSlider = factory((_props, ref) => {
  var _a;
  const props = useProps("ColorSlider", defaultProps77, _props);
  const {
    classNames,
    className,
    style,
  ...
  const layers = overlays.map((overlay, index5) => (0, import_react259.createElement)("div", { ...getStyles2("sliderOverlay"), style: overlay, key: index5 }));
  ...
  return (0, import_jsx_runtime175.jsxs)(
    Box,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime175.jsx)(Thumb2, { position, ...getStyles2("thumb", { style: { backgroundColor: color } }) })
      ]
    }
  );
}
...
var Swatches = (0, import_react263.forwardRef)(
  ({
    ...
    const colors = data.map((color, index5) => (0, import_react263.createElement)(
      ColorSwatch,
      {
    ...
    return (0, import_jsx_runtime176.jsx)(Box, { ...ctx.getStyles("swatches"), ref, ...others, children: colors });
  }
);
...
var varsResolver41 = createVarsResolver((_, { size: size4, swatchesPerRow }) => ({
  wrapper: {
...
var ColorPicker = factory((_props, ref) => {
  const props = useProps("ColorPicker", defaultProps79, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime177.jsx)(ColorPickerProvider, { value: { getStyles: getStyles2, unstyled }, children: (0, import_jsx_runtime177.jsxs)(
    Box,
    {
      ref,
      ...getStyles2("wrapper"),
      ...
      ...others,
      children: [
        withPicker && (0, import_jsx_runtime177.jsxs)(import_jsx_runtime177.Fragment, { children: [
          ...
          (0, import_jsx_runtime177.jsxs)("div", { ...getStyles2("body"), children: [
            (0, import_jsx_runtime177.jsxs)("div", { ...getStyles2("sliders"), children: [
              (0, import_jsx_runtime177.jsx)(
                HueSlider,
                {
                  value: parsed.h,
              ...
              withAlpha && (0, import_jsx_runtime177.jsx)(
                AlphaSlider,
                {
                  value: parsed.a,
        ...
        Array.isArray(swatches) && (0, import_jsx_runtime177.jsx)(
          Swatches,
          {
            data: swatches,
            swatchesPerRow,
...
function EyeDropperIcon({ style, ...others }) {
  return (0, import_jsx_runtime178.jsxs)(
    "svg",
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime178.jsx)("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }),
        (0, import_jsx_runtime178.jsx)("path", { d: "M11 7l6 6" }),
        (0, import_jsx_runtime178.jsx)("path", { d: "M4 16l11.7 -11.7a1 1 0 0 1 1.4 0l2.6 2.6a1 1 0 0 1 0 1.4l-11.7 11.7h-4v-4z" })
      ]
    }
  );
}
...
var varsResolver42 = createVarsResolver((_, { size: size4 }) => ({
  eyeDropperIcon: {
...
var ColorInput = factory((_props, ref) => {
  const props = useProps("ColorInput", defaultProps80, _props);
  const {
    classNames,
    styles,
    unstyled,
    ...
    swatchesPerRow,
    ...others
  } = useInputProps("ColorInput", defaultProps80, _props);
  const getStyles2 = useStyles({
    name: "ColorInput",
    props,
    classes: classes41,
  ...
  const eyeDropper = (0, import_jsx_runtime179.jsx)(
    ActionIcon,
    {
      ...eyeDropperButtonProps,
      ...
      children: eyeDropperIcon || (0, import_jsx_runtime179.jsx)(EyeDropperIcon, { ...getStyles2("eyeDropperIcon") })
    }
  );
    ...
    Input.Wrapper,
    {
      ...
      children: (0, import_jsx_runtime179.jsxs)(
        Popover,
        {
          ...
          children: [
            (0, import_jsx_runtime179.jsx)(Popover.Target, { children: (0, import_jsx_runtime179.jsx)(
              Input,
              {
                autoComplete: "off",
                ...others,
                ...
                leftSection: leftSection || (withPreview ? (0, import_jsx_runtime179.jsx)(
                  ColorSwatch,
                  {
...
function useVirtualizedCombobox({
  ...
  const listId = (0, import_react266.useRef)(null);
  const searchRef = (0, import_react266.useRef)(null);
  const targetRef = (0, import_react266.useRef)(null);
  const focusSearchTimeout = (0, import_react266.useRef)(-1);
  const focusTargetTimeout = (0, import_react266.useRef)(-1);
  const openDropdown = () => {
    if (!dropdownOpened) {
      setDropdownOpened(true);
  ...
  const getSelectedOptionIndex = (0, import_react266.useCallback)(() => selectedOptionIndex, []);
  return {
    dropdownOpened,
    openDropdown,
    closeDropdown,
...
// node_modules/@mantine/core/esm/components/Container/Container.mjs
var defaultProps81 = {};
var varsResolver43 = createVarsResolver((_, { size: size4, fluid }) => ({
  root: {
    "--container-size": fluid ? void 0 : getSize(size4, "container-size")
  }
}));
var Container = factory((_props, ref) => {
  const props = useProps("Container", defaultProps81, _props);
  ...
  return (0, import_jsx_runtime180.jsx)(Box, { ref, mod: [{ fluid }, mod], ...getStyles2("root"), ...others });
});
...
function CopyButton(props) {
  const { children, timeout, value, ...others } = useProps("CopyButton", defaultProps82, props);
  const clipboard = useClipboard({ timeout });
  const copy = () => clipboard.copy(value);
  return (0, import_jsx_runtime181.jsx)(import_jsx_runtime181.Fragment, { children: children({ copy, copied: clipboard.copied, ...others }) });
}
...
var Dialog = factory((_props, ref) => {
  const props = useProps("Dialog", defaultProps83, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime182.jsx)(
    Affix,
    {
      ...
      portalProps,
      unstyled,
      children: (0, import_jsx_runtime182.jsx)(Transition, { keepMounted, mounted: opened, ...transitionProps, children: (transitionStyles) => (0, import_jsx_runtime182.jsxs)(
        Paper,
        {
          unstyled,
          ...
          ...others,
          children: [
            withCloseButton && (0, import_jsx_runtime182.jsx)(CloseButton, { onClick: onClose, unstyled, ...getStyles2("closeButton") }),
            children
          ]
        }
      ) })
...
var varsResolver45 = createVarsResolver((theme, { color, variant, size: size4 }) => ({
  root: {
...
var Divider = factory((_props, ref) => {
  const props = useProps("Divider", defaultProps84, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime183.jsx)(
    Box,
    {
      ...
      ...others,
      role: "separator",
      children: label && (0, import_jsx_runtime183.jsx)(Box, { component: "span", mod: { position: labelPosition }, ...getStyles2("label"), children: label })
    }
  );
});
...
var DrawerBody = factory((_props, ref) => {
  const props = useProps("DrawerBody", defaultProps85, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
...
var DrawerCloseButton = factory((_props, ref) => {
  const props = useProps("DrawerCloseButton", defaultProps86, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useDrawerContext();
...
var DrawerContent = factory((_props, ref) => {
  const props = useProps("DrawerContent", defaultProps87, _props);
  ...
  return (0, import_jsx_runtime187.jsx)(
    ModalBaseContent,
    {
      ...
      children: (0, import_jsx_runtime187.jsx)(Scroll, { style: { height: "calc(100vh - var(--drawer-offset) * 2)" }, children })
    }
  );
});
...
var DrawerHeader = factory((_props, ref) => {
  const props = useProps("DrawerHeader", defaultProps88, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useDrawerContext();
...
var DrawerOverlay = factory((_props, ref) => {
  const props = useProps("DrawerOverlay", defaultProps89, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useDrawerContext();
...
var varsResolver46 = createVarsResolver((_, { position, size: size4, offset: offset4 }) => ({
  root: {
...
var DrawerRoot = factory((_props, ref) => {
  const props = useProps("DrawerRoot", defaultProps90, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime190.jsx)(DrawerProvider, { value: { scrollAreaComponent, getStyles: getStyles2, radius }, children: (0, import_jsx_runtime190.jsx)(
    ModalBase,
    {
      ref,
      ...getStyles2("root"),
...
var DrawerTitle = factory((_props, ref) => {
  const props = useProps("DrawerTitle", defaultProps91, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useDrawerContext();
...
var Drawer = factory((_props, ref) => {
  const {
    ...
    zIndex,
    ...others
  } = useProps("Drawer", defaultProps92, _props);
  ...
  return (0, import_jsx_runtime193.jsxs)(
    DrawerRoot,
    {
      ...
      ...stackProps,
      children: [
        withOverlay && (0, import_jsx_runtime193.jsx)(
          DrawerOverlay,
          {
        ...
        (0, import_jsx_runtime193.jsxs)(DrawerContent, { __hidden: ctx && stackId && opened ? stackId !== ctx.currentId : false, children: [
          hasHeader && (0, import_jsx_runtime193.jsxs)(DrawerHeader, { children: [
            title && (0, import_jsx_runtime193.jsx)(DrawerTitle, { children: title }),
            withCloseButton && (0, import_jsx_runtime193.jsx)(DrawerCloseButton, { ...closeButtonProps })
          ] }),
          (0, import_jsx_runtime193.jsx)(DrawerBody, { children })
        ] })
      ]
    }
  );
...
var varsResolver47 = createVarsResolver((_, { radius }) => ({
  root: {
    "--fieldset-radius": radius === void 0 ? void 0 : getRadius(radius)
  }
}));
var Fieldset = factory((_props, ref) => {
  const props = useProps("Fieldset", defaultProps93, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime194.jsxs)(
    Box,
    {
      component: "fieldset",
      ref,
      ...
      ...others,
      children: [
        legend && (0, import_jsx_runtime194.jsx)("legend", { ...getStyles2("legend", { variant }), children: legend }),
        children
      ]
    }
  );
...
var FileButton = (0, import_react282.forwardRef)(
  (props, ref) => {
    const {
      ...
      inputProps,
      ...others
    } = useProps("FileButton", defaultProps94, props);
    const inputRef = (0, import_react282.useRef)();
    const onClick = () => {
      var _a;
...
var DefaultValue = ({ value }) => (0, import_jsx_runtime196.jsx)("div", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: Array.isArray(value) ? value.map((file) => file.name).join(", ") : value == null ? void 0 : value.name });
var defaultProps95 = {
  valueComponent: DefaultValue
};
var _FileInput = factory((_props, ref) => {
  const props = useProps("FileInput", defaultProps95, _props);
  const {
    unstyled,
    vars,
    onChange,
  ...
  const _rightSection = rightSection || (clearable && hasValue && !readOnly ? (0, import_jsx_runtime196.jsx)(
    CloseButton,
    {
      ...clearButtonProps,
      variant: "subtle",
  ...
  return (0, import_jsx_runtime196.jsx)(
    FileButton,
    {
      ...
      children: (fileButtonProps) => (0, import_jsx_runtime196.jsx)(
        InputBase,
        {
          ...
          classNames,
          styles,
          children: !hasValue ? (0, import_jsx_runtime196.jsx)(
            Input.Placeholder,
            {
              __staticSelector: "FileInput",
              classNames: resolvedClassNames,
          ...
          ) : (0, import_jsx_runtime196.jsx)(ValueComponent, { value: _value })
        }
      )
    }
  );
...
var GridCol = factory((_props, ref) => {
  const props = useProps("GridCol", defaultProps96, _props);
...
var varsResolver48 = createVarsResolver((_, { justify, align, overflow }) => ({
  root: {
...
var Grid = factory((_props, ref) => {
  const props = useProps("Grid", defaultProps97, _props);
  const {
    classNames,
    className,
    style,
  ...
  if (type === "container" && breakpoints) {
    return (0, import_jsx_runtime201.jsxs)(GridProvider, { value: { getStyles: getStyles2, grow, columns: columns || 12, breakpoints, type }, children: [
      (0, import_jsx_runtime201.jsx)(GridVariables, { selector: `.${responsiveClassName}`, ...props }),
      (0, import_jsx_runtime201.jsx)("div", { ...getStyles2("container"), children: (0, import_jsx_runtime201.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others, children: (0, import_jsx_runtime201.jsx)("div", { ...getStyles2("inner"), children }) }) })
    ] });
  }
  return (0, import_jsx_runtime201.jsxs)(GridProvider, { value: { getStyles: getStyles2, grow, columns: columns || 12, breakpoints, type }, children: [
    (0, import_jsx_runtime201.jsx)(GridVariables, { selector: `.${responsiveClassName}`, ...props }),
    (0, import_jsx_runtime201.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others, children: (0, import_jsx_runtime201.jsx)("div", { ...getStyles2("inner"), children }) })
  ] });
});
...
var varsResolver49 = createVarsResolver((theme, { color }) => ({
  root: {
...
var Mark = factory((_props, ref) => {
  const props = useProps("Mark", defaultProps98, _props);
  ...
  return (0, import_jsx_runtime203.jsx)(Box, { component: "mark", ref, variant, ...getStyles2("root"), ...others });
});
...
var Highlight = polymorphicFactory((props, ref) => {
  ...
  return (0, import_jsx_runtime204.jsx)(Text, { unstyled, ref, ...others, __staticSelector: "Highlight", children: highlightChunks.map(
    ({ chunk, highlighted }, i) => highlighted ? (0, import_jsx_runtime204.jsx)(
      Mark,
      {
        unstyled,
        color,
      ...
      i
    ) : (0, import_jsx_runtime204.jsx)("span", { children: chunk }, i)
  ) });
});
...
function HoverCardDropdown(props) {
  ...
  return (0, import_jsx_runtime206.jsx)(Popover.Dropdown, { onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, ...others, children });
}
...
var HoverCardTarget = (0, import_react295.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime207.jsx)(Popover.Target, { refProp, ref, ...others, children: (0, import_react295.cloneElement)(
    children,
...
function HoverCard(props) {
  ...
  return (0, import_jsx_runtime208.jsx)(HoverCardContextProvider, { value: { openDropdown, closeDropdown }, children: (0, import_jsx_runtime208.jsx)(Popover, { ...others, opened, __staticSelector: "HoverCard", children }) });
}
...
// node_modules/@mantine/core/esm/components/Image/Image.mjs
var defaultProps103 = {};
var varsResolver50 = createVarsResolver((_, { radius, fit }) => ({
  root: {
...
var Image = polymorphicFactory((_props, ref) => {
  const props = useProps("Image", defaultProps103, _props);
  const {
    classNames,
    className,
    style,
  ...
  const [error2, setError] = (0, import_react298.useState)(!src);
...
var Indicator = factory((_props, ref) => {
  const props = useProps("Indicator", defaultProps104, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime211.jsxs)(Box, { ref, ...getStyles2("root"), mod: [{ inline: inline4 }, mod], ...others, children: [
    !disabled && (0, import_jsx_runtime211.jsx)(
      Box,
      {
...
var index3 = import_react301.useLayoutEffect;
...
var useComposedRef = function useComposedRef2(libRef, userRef) {
  var prevUserRef = (0, import_react302.useRef)();
  return (0, import_react302.useCallback)(function(instance) {
...
var JsonInput = factory((props, ref) => {
  const {
    ...
    error: error2,
    ...others
  } = useProps("JsonInput", defaultProps106, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: "",
  ...
  const [valid, setValid] = (0, import_react304.useState)(validateJson(_value, deserialize));
...
// node_modules/@mantine/core/esm/components/Kbd/Kbd.mjs
var defaultProps107 = {};
var varsResolver52 = createVarsResolver((_, { size: size4 }) => ({
  root: {
...
var Kbd = factory((_props, ref) => {
  const props = useProps("Kbd", defaultProps107, _props);
  const { classNames, className, style, styles, unstyled, vars, ...others } = props;
  const getStyles2 = useStyles({
    name: "Kbd",
    classes: classes51,
  ...
  return (0, import_jsx_runtime214.jsx)(Box, { component: "kbd", ref, ...getStyles2("root"), ...others });
});
...
var ListItem = factory((_props, ref) => {
  const props = useProps("ListItem", defaultProps108, _props);
  ...
  return (0, import_jsx_runtime216.jsx)(
    Box,
    {
      ...
      ref,
      ...others,
      children: (0, import_jsx_runtime216.jsxs)("div", { ...ctx.getStyles("itemWrapper", stylesApiProps), children: [
        _icon && (0, import_jsx_runtime216.jsx)("span", { ...ctx.getStyles("itemIcon", stylesApiProps), children: _icon }),
        (0, import_jsx_runtime216.jsx)("span", { ...ctx.getStyles("itemLabel", stylesApiProps), children })
      ] })
    }
  );
});
...
var varsResolver53 = createVarsResolver((_, { size: size4, spacing }) => ({
  root: {
...
var List = factory((_props, ref) => {
  const props = useProps("List", defaultProps109, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime217.jsx)(ListProvider, { value: { center, icon, getStyles: getStyles2 }, children: (0, import_jsx_runtime217.jsx)(
    Box,
    {
...
var varsResolver54 = createVarsResolver((_, { zIndex }) => ({
  root: {
    "--lo-z-index": zIndex == null ? void 0 : zIndex.toString()
  }
}));
var LoadingOverlay = factory((_props, ref) => {
  const props = useProps("LoadingOverlay", defaultProps110, _props);
  const {
    classNames,
    className,
    style,
  ...
  const _overlayProps = { ...defaultProps110.overlayProps, ...overlayProps };
  return (0, import_jsx_runtime218.jsx)(Transition, { transition: "fade", ...transitionProps, mounted: !!visible2, children: (transitionStyles) => (0, import_jsx_runtime218.jsxs)(Box, { ...getStyles2("root", { style: transitionStyles }), ref, ...others, children: [
    (0, import_jsx_runtime218.jsx)(Loader, { ...getStyles2("loader"), unstyled, ...loaderProps }),
    (0, import_jsx_runtime218.jsx)(
      Overlay,
      {
        ..._overlayProps,
        ...getStyles2("overlay"),
...
var MenuDropdown = factory((props, ref) => {
  const {
    ...
    children,
    ...others
  } = useProps("MenuDropdown", defaultProps112, props);
  const wrapperRef = (0, import_react312.useRef)(null);
  const ctx = useMenuContext();
  ...
  return (0, import_jsx_runtime221.jsxs)(
    Popover.Dropdown,
    {
      ...
      onKeyDown: handleKeyDown,
      children: [
        (0, import_jsx_runtime221.jsx)("div", { tabIndex: -1, "data-autofocus": true, "data-mantine-stop-propagation": true, style: { outline: 0 } }),
        children
      ]
    }
  );
...
var MenuItem = polymorphicFactory((props, ref) => {
  const {
    ...
    disabled,
    ...others
  } = useProps("MenuItem", defaultProps113, props);
  const ctx = useMenuContext();
  const theme = useMantineTheme();
  const { dir } = useDirection();
  const itemRef = (0, import_react313.useRef)();
  ...
  return (0, import_jsx_runtime222.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        leftSection && (0, import_jsx_runtime222.jsx)("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "left", children: leftSection }),
        children && (0, import_jsx_runtime222.jsx)("div", { ...ctx.getStyles("itemLabel", { styles, classNames }), children }),
        rightSection && (0, import_jsx_runtime222.jsx)("div", { ...ctx.getStyles("itemSection", { styles, classNames }), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var MenuTarget = (0, import_react315.forwardRef)((props, ref) => {
  const { children, refProp, ...others } = useProps("MenuTarget", defaultProps115, props);
  if (!isElement(children)) {
    throw new Error(
  ...
  return (0, import_jsx_runtime224.jsx)(Popover.Target, { refProp, popupType: "menu", ref, ...others, children: (0, import_react315.cloneElement)(children, {
    onClick,
    onMouseEnter,
    onMouseLeave,
...
function Menu(_props) {
  const props = useProps("Menu", defaultProps116, _props);
  const {
    children,
    onOpen,
    onClose,
  ...
  const [openedViaClick, setOpenedViaClick] = (0, import_react316.useState)(false);
  const close = () => {
    setOpened(false);
  ...
  return (0, import_jsx_runtime225.jsx)(
    MenuContextProvider,
    {
      ...
      children: (0, import_jsx_runtime225.jsx)(
        Popover,
        {
          ...others,
          opened: _opened,
...
var ModalBody = factory((_props, ref) => {
  const props = useProps("ModalBody", defaultProps117, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
...
var ModalCloseButton = factory((_props, ref) => {
  const props = useProps("ModalCloseButton", defaultProps118, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useModalContext();
...
var ModalContent = factory((_props, ref) => {
  const props = useProps("ModalContent", defaultProps119, _props);
...
var ModalHeader = factory((_props, ref) => {
  const props = useProps("ModalHeader", defaultProps120, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useModalContext();
...
var ModalOverlay = factory((_props, ref) => {
  const props = useProps("ModalOverlay", defaultProps121, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useModalContext();
...
var ModalRoot = factory((_props, ref) => {
  const props = useProps("ModalRoot", defaultProps122, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime232.jsx)(ModalProvider, { value: { yOffset, scrollAreaComponent, getStyles: getStyles2, fullScreen }, children: (0, import_jsx_runtime232.jsx)(
    ModalBase,
    {
      ref,
      ...getStyles2("root"),
...
function ModalStack({ children }) {
  const [stack, setStack] = (0, import_react325.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react325.useState)(getDefaultZIndex("modal"));
...
var ModalTitle = factory((_props, ref) => {
  const props = useProps("ModalTitle", defaultProps123, _props);
  const { classNames, className, style, styles, vars, ...others } = props;
  const ctx = useModalContext();
...
var Modal = factory((_props, ref) => {
  const {
    ...
    zIndex,
    ...others
  } = useProps("Modal", defaultProps124, _props);
  ...
  return (0, import_jsx_runtime235.jsxs)(
    ModalRoot,
    {
      ...
      ...stackProps,
      children: [
        withOverlay && (0, import_jsx_runtime235.jsx)(
          ModalOverlay,
          {
            visible: overlayVisible,
            transitionProps: ctx && stackId ? { duration: 0 } : void 0,
        ...
        (0, import_jsx_runtime235.jsxs)(
          ModalContent,
          {
            ...
            children: [
              hasHeader && (0, import_jsx_runtime235.jsxs)(ModalHeader, { children: [
                title && (0, import_jsx_runtime235.jsx)(ModalTitle, { children: title }),
                withCloseButton && (0, import_jsx_runtime235.jsx)(ModalCloseButton, { ...closeButtonProps })
              ] }),
              (0, import_jsx_runtime235.jsx)(ModalBody, { children })
            ]
          }
        )
      ]
...
function useModalsStack(modals) {
  ...
  const [state, setState] = (0, import_react328.useState)(initialState);
  const open = (0, import_react328.useCallback)((modal) => {
    setState((current) => ({ ...current, [modal]: true }));
  }, []);
  const close = (0, import_react328.useCallback)(
    (modal) => setState((current) => ({ ...current, [modal]: false })),
    []
  );
  const toggle = (0, import_react328.useCallback)(
    (modal) => setState((current) => ({ ...current, [modal]: !current[modal] })),
    []
  );
  const closeAll = (0, import_react328.useCallback)(() => setState(initialState), []);
  const register = (0, import_react328.useCallback)(
    (modal) => ({
      opened: state[modal],
      onClose: () => close(modal),
      stackId: modal
...
// node_modules/@mantine/core/esm/components/Pill/PillGroup/PillGroup.mjs
var defaultProps125 = {};
var varsResolver56 = createVarsResolver((_, { gap }, { size: size4 }) => ({
  group: {
    "--pg-gap": gap !== void 0 ? getSize(gap) : getSize(size4, "pg-gap")
  }
}));
var PillGroup = factory((_props, ref) => {
  const props = useProps("PillGroup", defaultProps125, _props);
  ...
  return (0, import_jsx_runtime238.jsx)(PillGroupProvider, { value: { size: _size, disabled }, children: (0, import_jsx_runtime238.jsx)(Box, { ref, size: _size, ...getStyles2("group"), ...others }) });
});
...
var varsResolver57 = createVarsResolver((_, { radius }, { size: size4 }) => ({
  root: {
...
var Pill = factory((_props, ref) => {
  const props = useProps("Pill", defaultProps126, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime239.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        (0, import_jsx_runtime239.jsx)("span", { ...getStyles2("label"), children }),
        withRemoveButton && (0, import_jsx_runtime239.jsx)(
          CloseButton,
          {
            variant: "transparent",
            radius,
...
var PillsInputField = factory((_props, ref) => {
  const props = useProps("PillsInputField", defaultProps127, _props);
  const {
    classNames,
    className,
    style,
...
var PillsInput = factory((_props, ref) => {
  const props = useProps("PillsInput", defaultProps128, _props);
  const {
    children,
    onMouseDown,
    onClick,
  ...
  const fieldRef = (0, import_react334.useRef)();
  return (0, import_jsx_runtime241.jsx)(PillsInputProvider, { value: { fieldRef, size: size4, disabled, hasError: !!error2, variant }, children: (0, import_jsx_runtime241.jsx)(
    InputBase,
    {
      size: size4,
      error: error2,
...
var MultiSelect = factory((_props, ref) => {
  const props = useProps("MultiSelect", defaultProps129, _props);
  const {
    classNames,
    className,
    style,
  ...
  const clearButton = clearable && _value.length > 0 && !disabled && !readOnly && (0, import_jsx_runtime243.jsx)(
  ...
  return (0, import_jsx_runtime243.jsxs)(import_jsx_runtime243.Fragment, { children: [
    (0, import_jsx_runtime243.jsxs)(
      Combobox,
      {
        ...
        ...comboboxProps,
        children: [
          (0, import_jsx_runtime243.jsx)(Combobox.DropdownTarget, { children: (0, import_jsx_runtime243.jsx)(
            PillsInput,
            {
              ...styleProps,
              __staticSelector: "MultiSelect",
              ...
              disabled,
              radius,
              rightSection: rightSection || clearButton || (0, import_jsx_runtime243.jsx)(Combobox.Chevron, { size: size4, error: error2, unstyled }),
              ...
              required,
              mod,
              children: (0, import_jsx_runtime243.jsxs)(Pill.Group, { disabled, unstyled, ...getStyles2("pillsList"), children: [
                values2,
                (0, import_jsx_runtime243.jsx)(Combobox.EventsTarget, { autoComplete, children: (0, import_jsx_runtime243.jsx)(
                  PillsInput.Field,
                  {
                    ...rest,
                    ref,
...
function NativeSelectOption({ data }) {
  if (isGroup(data)) {
    const items = data.items.map((item) => (0, import_jsx_runtime244.jsx)(NativeSelectOption, { data: item }, item.value));
    return (0, import_jsx_runtime244.jsx)("optgroup", { label: data.group, children: items });
  }
  const { value, label, ...others } = data;
  return (0, import_jsx_runtime244.jsx)("option", { value: data.value, ...others, children: data.label }, data.value);
}
...
var NativeSelect = factory((props, ref) => {
  ...
  const options = getParsedComboboxData(data).map((item, index5) => (0, import_jsx_runtime245.jsx)(NativeSelectOption, { data: item }, index5));
  return (0, import_jsx_runtime245.jsx)(
    InputBase,
    {
      ...
      error: error2,
      unstyled,
      rightSection: rightSection || (0, import_jsx_runtime245.jsx)(ComboboxChevron, { size: size4, error: error2, unstyled }),
...
var NavLink = polymorphicFactory((_props, ref) => {
  const props = useProps("NavLink", defaultProps131, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime246.jsxs)(import_jsx_runtime246.Fragment, { children: [
    (0, import_jsx_runtime246.jsxs)(
      UnstyledButton,
      {
        ...
        ...others,
        children: [
          leftSection && (0, import_jsx_runtime246.jsx)(Box, { component: "span", ...getStyles2("section"), mod: { position: "left" }, children: leftSection }),
          (0, import_jsx_runtime246.jsxs)(Box, { ...getStyles2("body"), mod: { "no-wrap": noWrap }, children: [
            (0, import_jsx_runtime246.jsx)(Box, { component: "span", ...getStyles2("label"), children: label }),
            (0, import_jsx_runtime246.jsx)(Box, { component: "span", mod: { active }, ...getStyles2("description"), children: description })
          ] }),
          (withChildren || rightSection) && (0, import_jsx_runtime246.jsx)(
            Box,
            {
              ...getStyles2("section"),
              component: "span",
              mod: { rotate: _opened && !disableRightSectionRotation, position: "right" },
              children: withChildren ? rightSection || (0, import_jsx_runtime246.jsx)(AccordionChevron, { ...getStyles2("chevron") }) : rightSection
            }
          )
        ]
      }
    ),
    withChildren && (0, import_jsx_runtime246.jsx)(Collapse, { in: _opened, ...getStyles2("collapse"), children: (0, import_jsx_runtime246.jsx)("div", { ...getStyles2("children"), children }) })
  ] });
});
...
var varsResolver59 = createVarsResolver((theme, { radius, color }) => ({
  root: {
...
var Notification = factory((_props, ref) => {
  const props = useProps("Notification", defaultProps132, _props);
  const {
    className,
    color,
    radius,
  ...
  return (0, import_jsx_runtime247.jsxs)(
    Box,
    {
      ...getStyles2("root"),
      ...
      role: "alert",
      children: [
        icon && !loading && (0, import_jsx_runtime247.jsx)("div", { ...getStyles2("icon"), children: icon }),
        loading && (0, import_jsx_runtime247.jsx)(Loader, { size: 28, color, ...getStyles2("loader") }),
        (0, import_jsx_runtime247.jsxs)("div", { ...getStyles2("body"), children: [
          title && (0, import_jsx_runtime247.jsx)("div", { ...getStyles2("title"), children: title }),
          (0, import_jsx_runtime247.jsx)(Box, { ...getStyles2("description"), mod: { "data-with-title": !!title }, children })
        ] }),
        withCloseButton && (0, import_jsx_runtime247.jsx)(
          CloseButton,
          {
            iconSize: 16,
            color: "gray",
...
function usePersistentCallback(cb) {
  var callbackRef = (0, import_react340.useRef)(cb);
  callbackRef.current = cb;
  var persistentCbRef = (0, import_react340.useRef)(function() {
    var args = [], len = arguments.length;
    while (len--) args[len] = arguments[len];
...
function useInternalValues(value, defaultValue, valueIsNumericString, format2, removeFormatting2, onValueChange) {
  ...
  var ref = (0, import_react340.useState)(function() {
  ...
  (0, import_react340.useMemo)(function() {
    setValues(newValues);
...
function NumberFormatBase(props) {
  ...
  var caretPositionBeforeChange = (0, import_react340.useRef)();
  var lastUpdatedValue = (0, import_react340.useRef)({ formattedValue, numAsString });
  ...
  var ref$1 = (0, import_react340.useState)(false);
  var mounted = ref$1[0];
  var setMounted = ref$1[1];
  var focusedElm = (0, import_react340.useRef)(null);
  var timeout = (0, import_react340.useRef)({
    setCaretTimeout: null,
    focusTimeout: null
  });
  (0, import_react340.useEffect)(function() {
    setMounted(true);
    return function() {
  ...
  var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? import_react340.useLayoutEffect : import_react340.useEffect;
  ...
  if (displayType === "text") {
    return renderText ? import_react340.default.createElement(import_react340.default.Fragment, null, renderText(formattedValue, otherProps) || null) : import_react340.default.createElement("span", Object.assign({}, otherProps, { ref: getInputRef }), formattedValue);
  } else if (customInput) {
    var CustomInput = customInput;
    return import_react340.default.createElement(CustomInput, Object.assign({}, inputProps, { ref: getInputRef }));
  }
  return import_react340.default.createElement("input", Object.assign({}, inputProps, { ref: getInputRef }));
}
...
function NumericFormat(props) {
  ...
  return import_react340.default.createElement(NumberFormatBase, Object.assign({}, numericFormatProps));
}
...
function NumberFormatter(_props) {
  const props = useProps("NumberFormatter", defaultProps133, _props);
  const { value, defaultValue, ...others } = props;
  if (value === void 0) {
    return null;
  }
  return (0, import_jsx_runtime248.jsx)(NumericFormat, { displayType: "text", value, ...others });
}
...
function NumberInputChevron({ direction, style, ...others }) {
  return (0, import_jsx_runtime249.jsx)(
    "svg",
    {
      ...
      xmlns: "http://www.w3.org/2000/svg",
      ...others,
      children: (0, import_jsx_runtime249.jsx)(
        "path",
        {
          d: "M3.13523 6.15803C3.3241 5.95657 3.64052 5.94637 3.84197 6.13523L7.5 9.56464L11.158 6.13523C11.3595 5.94637 11.6759 5.95657 11.8648 6.15803C12.0536 6.35949 12.0434 6.67591 11.842 6.86477L7.84197 10.6148C7.64964 10.7951 7.35036 10.7951 7.15803 10.6148L3.15803 6.86477C2.95657 6.67591 2.94637 6.35949 3.13523 6.15803Z",
          fill: "currentColor",
...
var varsResolver60 = createVarsResolver((_, { size: size4 }) => ({
  controls: {
    "--ni-chevron-size": getSize(size4, "ni-chevron-size")
  }
}));
var NumberInput = factory((_props, ref) => {
  const props = useProps("NumberInput", defaultProps134, _props);
  const {
    className,
    classNames,
    styles,
  ...
  const onStepTimeoutRef = (0, import_react342.useRef)(null);
  const stepCountRef = (0, import_react342.useRef)(0);
  ...
  const incrementRef = (0, import_react342.useRef)();
  ...
  const decrementRef = (0, import_react342.useRef)();
  ...
  const controls = (0, import_jsx_runtime250.jsxs)("div", { ...getStyles2("controls"), children: [
    (0, import_jsx_runtime250.jsx)(
      UnstyledButton,
      {
        ...getStyles2("control"),
        tabIndex: -1,
        ...
        children: (0, import_jsx_runtime250.jsx)(NumberInputChevron, { direction: "up" })
      }
    ),
    (0, import_jsx_runtime250.jsx)(
      UnstyledButton,
      {
        ...
        onPointerUp: onStepDone,
        onPointerLeave: onStepDone,
        children: (0, import_jsx_runtime250.jsx)(NumberInputChevron, { direction: "down" })
      }
    )
  ] });
...
var PaginationControl = factory((_props, ref) => {
  const props = useProps("PaginationControl", defaultProps135, _props);
  const {
    classNames,
    className,
    style,
...
function PaginationIcon({ style, children, path, ...others }) {
  return (0, import_jsx_runtime253.jsx)(
    "svg",
    {
      ...
      ...others,
      children: (0, import_jsx_runtime253.jsx)("path", { d: path, fill: "currentColor" })
    }
  );
}
var PaginationNextIcon = (props) => (0, import_jsx_runtime253.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationPreviousIcon = (props) => (0, import_jsx_runtime253.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationFirstIcon = (props) => (0, import_jsx_runtime253.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationLastIcon = (props) => (0, import_jsx_runtime253.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationDotsIcon = (props) => (0, import_jsx_runtime253.jsx)(
  PaginationIcon,
  {
    ...props,
...
var PaginationDots = factory((_props, ref) => {
  const props = useProps("PaginationDots", defaultProps136, _props);
  const { classNames, className, style, styles, vars, icon, ...others } = props;
  const ctx = usePaginationContext();
  const Icon = icon;
  return (0, import_jsx_runtime254.jsx)(Box, { ref, ...ctx.getStyles("dots", { className, style, styles, classNames }), ...others, children: (0, import_jsx_runtime254.jsx)(
    Icon,
    {
      style: {
        width: "calc(var(--pagination-control-size) / 1.8)",
...
function createEdgeComponent({ icon, name, action, type }) {
  const defaultProps182 = { icon };
  const Component = (0, import_react346.forwardRef)((props, ref) => {
    const { icon: _icon, ...others } = useProps(name, defaultProps182, props);
    const Icon = _icon;
    const ctx = usePaginationContext();
...
function PaginationItems({ dotsIcon }) {
  ...
  const items = ctx.range.map((page, index5) => {
    var _a, _b, _c;
    if (page === "dots") {
      return (0, import_jsx_runtime256.jsx)(PaginationDots, { icon: dotsIcon }, index5);
    }
  ...
  return (0, import_jsx_runtime256.jsx)(import_jsx_runtime256.Fragment, { children: items });
}
...
var PaginationRoot = factory((_props, ref) => {
  const props = useProps("PaginationRoot", defaultProps137, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime257.jsx)(
    PaginationProvider,
    {
      ...
      children: (0, import_jsx_runtime257.jsx)(Box, { ref, ...getStyles2("root"), ...others })
    }
  );
});
...
var Pagination = factory((_props, ref) => {
  const props = useProps("Pagination", defaultProps138, _props);
  const {
    withEdges,
    withControls,
    getControlProps,
  ...
  return (0, import_jsx_runtime258.jsx)(PaginationRoot, { ref, total, ...others, children: (0, import_jsx_runtime258.jsxs)(Group, { gap, children: [
    withEdges && (0, import_jsx_runtime258.jsx)(PaginationFirst, { icon: firstIcon, ...getControlProps == null ? void 0 : getControlProps("first") }),
    withControls && (0, import_jsx_runtime258.jsx)(PaginationPrevious, { icon: previousIcon, ...getControlProps == null ? void 0 : getControlProps("previous") }),
    (0, import_jsx_runtime258.jsx)(PaginationItems, { dotsIcon }),
    withControls && (0, import_jsx_runtime258.jsx)(PaginationNext, { icon: nextIcon, ...getControlProps == null ? void 0 : getControlProps("next") }),
    withEdges && (0, import_jsx_runtime258.jsx)(PaginationLast, { icon: lastIcon, ...getControlProps == null ? void 0 : getControlProps("last") })
  ] }) });
});
...
var PasswordInput = factory((_props, ref) => {
  const props = useProps("PasswordInput", defaultProps139, _props);
  const {
    classNames,
    className,
    style,
  ...
  const visibilityToggleButton = (0, import_jsx_runtime260.jsx)(
    ActionIcon,
    {
      ...
      children: (0, import_jsx_runtime260.jsx)(VisibilityToggleIcon, { reveal: _visible })
    }
  );
...
var varsResolver63 = createVarsResolver((_, { size: size4 }) => ({
  root: {
    "--pin-input-size": getSize(size4 ?? defaultProps140.size, "pin-input-size")
  }
}));
var PinInput = factory((props, ref) => {
  const {
    ...
    getInputProps,
    ...others
  } = useProps("PinInput", defaultProps140, props);
  const uuid = useId(id);
  const getStyles2 = useStyles({
    name: "PinInput",
    classes: classes63,
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react350.useState)(-1);
  ...
  const inputsRef = (0, import_react350.useRef)([]);
  const validate = (code) => {
  ...
  return (0, import_jsx_runtime261.jsxs)(import_jsx_runtime261.Fragment, { children: [
    (0, import_jsx_runtime261.jsx)(
      Group,
      {
        ...
        __size: size4,
        dir: "ltr",
        children: _value.map((char, index5) => (0, import_react350.createElement)(
          Input,
          {
            component: "input",
            ...getStyles2("pinInput", {
    ...
    (0, import_jsx_runtime261.jsx)("input", { type: "hidden", name, form, value: _valueToString, ...hiddenInputProps })
  ] });
});
...
var defaultProps142 = {};
var varsResolver64 = createVarsResolver(
...
var ProgressRoot = factory((_props, ref) => {
  const props = useProps("ProgressRoot", defaultProps142, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime264.jsx)(ProgressProvider, { value: { getStyles: getStyles2, autoContrast }, children: (0, import_jsx_runtime264.jsx)(Box, { ref, ...getStyles2("root"), ...others }) });
});
...
var ProgressSection = factory((props, ref) => {
  const {
    ...
    mod,
    ...others
  } = useProps("ProgressSection", defaultProps143, props);
  const ctx = useProgressContext();
  const theme = useMantineTheme();
  const ariaAttributes = withAria ? {
    role: "progressbar",
...
var Progress = factory((_props, ref) => {
  const props = useProps("Progress", defaultProps144, _props);
  const {
    value,
    classNames,
    styles,
...
var varsResolver65 = createVarsResolver((_, { radius }) => ({
  card: {
    "--card-radius": getRadius(radius)
  }
}));
var RadioCard = factory((_props, ref) => {
  const props = useProps("RadioCard", defaultProps145, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime269.jsx)(RadioCardProvider, { value: { checked: _checked }, children: (0, import_jsx_runtime269.jsx)(
    UnstyledButton,
    {
      ref,
...
var RadioGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size4, wrapperProps, children, name, readOnly, ...others } = useProps("RadioGroup", defaultProps146, props);
  ...
  return (0, import_jsx_runtime270.jsx)(RadioGroupProvider, { value: { value: _value, onChange: handleChange, size: size4, name: _name }, children: (0, import_jsx_runtime270.jsx)(
    Input.Wrapper,
    {
      size: size4,
      ref,
      ...
      children: (0, import_jsx_runtime270.jsx)(InputsGroupFieldset, { role: "radiogroup", children })
    }
  ) });
});
...
function RadioIcon({ size: size4, style, ...others }) {
  return (0, import_jsx_runtime271.jsx)(
    "svg",
    {
      ...
      "aria-hidden": true,
      ...others,
      children: (0, import_jsx_runtime271.jsx)("circle", { cx: "2.5", cy: "2.5", r: "2.5", fill: "currentColor" })
    }
  );
}
...
var RadioIndicator = factory((_props, ref) => {
  const props = useProps("RadioIndicator", defaultProps147, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime272.jsx)(
    Box,
    {
      ...
      mod: [{ checked: _checked, disabled }, mod],
      ...others,
      children: (0, import_jsx_runtime272.jsx)(Icon, { ...getStyles2("icon") })
    }
  );
});
...
var Radio = factory((_props, ref) => {
  const props = useProps("Radio", defaultProps148, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime273.jsx)(
    InlineInput,
    {
      ...
      ...styleProps,
      ...wrapperProps,
      children: (0, import_jsx_runtime273.jsxs)(Box, { ...getStyles2("inner"), mod: { "label-position": labelPosition }, children: [
        ...
        (0, import_jsx_runtime273.jsx)(Icon, { ...getStyles2("icon"), "aria-hidden": true })
      ] })
    }
  );
});
...
function StarIcon(props) {
  ...
  return (0, import_jsx_runtime275.jsx)(
    "svg",
    {
      ...
      ...others,
      children: (0, import_jsx_runtime275.jsx)("path", { d: "M12 17.75l-6.172 3.245l1.179 -6.873l-5 -4.867l6.9 -1l3.086 -6.253l3.086 6.253l6.9 1l-5 4.867l1.179 6.873z" })
    }
  );
}
...
function StarSymbol({ type }) {
  ...
  return (0, import_jsx_runtime276.jsx)(StarIcon, { ...ctx.getStyles("starSymbol"), "data-filled": type === "full" || void 0 });
}
...
function RatingItem({
  ...
  return (0, import_jsx_runtime277.jsxs)(import_jsx_runtime277.Fragment, { children: [
    !readOnly && (0, import_jsx_runtime277.jsx)(
      "input",
      {
        ...ctx.getStyles("input"),
      ...
      Box,
      {
        ...
        children: (0, import_jsx_runtime277.jsx)(
          Box,
          {
            ...
            children: full ? _fullIcon || (0, import_jsx_runtime277.jsx)(StarSymbol, { type: "full" }) : _emptyIcon || (0, import_jsx_runtime277.jsx)(StarSymbol, { type: "empty" })
          }
        )
      }
    )
...
var varsResolver68 = createVarsResolver((theme, { size: size4, color }) => ({
  root: {
...
var Rating = factory((_props, ref) => {
  const props = useProps("Rating", defaultProps149, _props);
  const {
    classNames,
    className,
    style,
  ...
  const _name = useId(name);
  const _id = useId(id);
  const rootRef = (0, import_react365.useRef)(null);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: 0,
  ...
  const [hovered, setHovered] = (0, import_react365.useState)(-1);
  const [isOutside, setOutside] = (0, import_react365.useState)(true);
  ...
  return (0, import_jsx_runtime278.jsx)(RatingProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime278.jsx)(
    Box,
    {
...
function useFloatingTooltip({
  ...
  const [opened, setOpened] = (0, import_react366.useState)(defaultOpened);
  const boundaryRef = (0, import_react366.useRef)();
  ...
  const handleMouseMove = (0, import_react366.useCallback)(
    ({ clientX, clientY }) => {
...
var TooltipFloating = factory((_props, ref) => {
  const props = useProps("TooltipFloating", defaultProps150, _props);
  const {
    children,
    refProp,
    withinPortal,
  ...
  return (0, import_jsx_runtime279.jsxs)(import_jsx_runtime279.Fragment, { children: [
    (0, import_jsx_runtime279.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime279.jsx)(
      Box,
      {
        ...others,
        ...getStyles2("tooltip", {
    ...
    (0, import_react368.cloneElement)(children, {
      ...children.props,
      [refProp]: targetRef,
      onMouseEnter,
      onMouseLeave
...
var TooltipGroupContext = (0, import_react369.createContext)(false);
var TooltipGroupProvider = TooltipGroupContext.Provider;
var useTooltipGroupContext = () => (0, import_react369.useContext)(TooltipGroupContext);
...
function TooltipGroup(props) {
  const { openDelay, closeDelay, children } = useProps("TooltipGroup", defaultProps151, props);
  return (0, import_jsx_runtime280.jsx)(TooltipGroupProvider, { value: true, children: (0, import_jsx_runtime280.jsx)(FloatingDelayGroup, { delay: { open: openDelay, close: closeDelay }, children }) });
}
...
function useTooltip(settings) {
  var _a, _b, _c;
  const [uncontrolledOpened, setUncontrolledOpened] = (0, import_react372.useState)(settings.defaultOpened);
  const controlled = typeof settings.opened === "boolean";
  const opened = controlled ? settings.opened : uncontrolledOpened;
  const withinGroup = useTooltipGroupContext();
  const uid = useId();
  const { delay: groupDelay, currentId, setCurrentId } = useDelayGroupContext();
  const onChange = (0, import_react372.useCallback)(
    (_opened) => {
...
var varsResolver70 = createVarsResolver((theme, { radius, color }) => ({
  tooltip: {
    "--tooltip-radius": radius === void 0 ? void 0 : getRadius(radius),
    "--tooltip-bg": color ? getThemeColor(color, theme) : void 0,
    "--tooltip-color": color ? "var(--mantine-color-white)" : void 0
...
var Tooltip = factory((_props, ref) => {
  const props = useProps("Tooltip", defaultProps152, _props);
  const {
    children,
    position,
    refProp,
    ...
    floatingStrategy,
    ...others
  } = useProps("Tooltip", defaultProps152, props);
  const { dir } = useDirection();
  const arrowRef = (0, import_react374.useRef)(null);
  ...
  return (0, import_jsx_runtime281.jsxs)(import_jsx_runtime281.Fragment, { children: [
    (0, import_jsx_runtime281.jsx)(OptionalPortal, { ...portalProps, withinPortal, children: (0, import_jsx_runtime281.jsx)(
      Transition,
      {
        ...
        children: (transitionStyles) => (0, import_jsx_runtime281.jsxs)(
          Box,
          {
            ...others,
    ...
    (0, import_react374.cloneElement)(
      children,
...
function Curve({
  ...
  const theme = useMantineTheme();
  return (0, import_jsx_runtime282.jsx)(Tooltip.Floating, { disabled: !tooltip, label: tooltip, children: (0, import_jsx_runtime282.jsx)(
    Box,
    {
      component: "circle",
      ...others,
...
var RingProgress = factory((_props, ref) => {
  const props = useProps("RingProgress", defaultProps153, _props);
  const {
    classNames,
    className,
    style,
  ...
  const curves = getCurves({
    ...
    rootColor
  }).map(({ data, sum, root, lineRoundCaps, offset: offset4 }, index5) => (0, import_react377.createElement)(
    Curve,
    {
      ...data,
      key: index5,
  ...
  return (0, import_jsx_runtime283.jsxs)(Box, { ...getStyles2("root"), size: size4, ref, ...others, children: [
    (0, import_jsx_runtime283.jsx)("svg", { ...getStyles2("svg"), children: curves }),
    label && (0, import_jsx_runtime283.jsx)("div", { ...getStyles2("label"), children: label })
  ] });
});
...
var SegmentedControl = factory((_props, ref) => {
  var _a, _b;
  const props = useProps("SegmentedControl", defaultProps154, _props);
  const {
    classNames,
    className,
    style,
  ...
  const [parent, setParent] = (0, import_react378.useState)(null);
  const [refs, setRefs] = (0, import_react378.useState)({});
  ...
  const controls = _data.map((item) => (0, import_react378.createElement)(
    Box,
    {
      ...getStyles2("control"),
    ...
    (0, import_react378.createElement)(
      "input",
      {
        ...getStyles2("input"),
    ...
    (0, import_react378.createElement)(
      ...
      (0, import_jsx_runtime284.jsx)("span", { ...getStyles2("innerLabel"), children: item.label })
    )
  ));
  ...
  return (0, import_jsx_runtime284.jsxs)(
    Box,
    {
      ...getStyles2("root"),
      variant,
      ...
      children: [
        typeof _value === "string" && (0, import_jsx_runtime284.jsx)(
          FloatingIndicator,
          {
            target: refs[_value],
            parent,
...
var Select = factory((_props, ref) => {
  const props = useProps("Select", defaultProps155, _props);
  const {
    classNames,
    styles,
    unstyled,
  ...
  const parsedData = (0, import_react379.useMemo)(() => getParsedComboboxData(data), [data]);
  const optionsLockup = (0, import_react379.useMemo)(() => getOptionsLockup(parsedData), [parsedData]);
  const _id = useId(id);
  const [_value, setValue, controlled] = useUncontrolled({
    value,
    defaultValue,
  ...
  const clearButton = clearable && !!_value && !disabled && !readOnly && (0, import_jsx_runtime285.jsx)(
    Combobox.ClearButton,
    {
      size: size4,
      ...clearButtonProps,
  ...
  return (0, import_jsx_runtime285.jsxs)(import_jsx_runtime285.Fragment, { children: [
    (0, import_jsx_runtime285.jsxs)(
      Combobox,
      {
        ...
        ...comboboxProps,
        children: [
          (0, import_jsx_runtime285.jsx)(Combobox.Target, { targetType: searchable ? "input" : "button", autoComplete, children: (0, import_jsx_runtime285.jsx)(
            InputBase,
            {
              id: _id,
              ref,
              rightSection: rightSection || clearButton || (0, import_jsx_runtime285.jsx)(Combobox.Chevron, { size: size4, error: error2, unstyled }),
              rightSectionPointerEvents: rightSectionPointerEvents || (clearButton ? "all" : "none"),
              ...others,
              size: size4,
              __staticSelector: "Select",
...
var SemiCircleProgress = factory((_props, ref) => {
  const props = useProps("SemiCircleProgress", defaultProps156, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime286.jsxs)(Box, { ref, size: size4, ...getStyles2("root"), ...others, children: [
    label && (0, import_jsx_runtime286.jsx)("p", { ...getStyles2("label"), "data-position": labelPosition, "data-orientation": orientation, children: label }),
    (0, import_jsx_runtime286.jsxs)("svg", { width: size4, height: size4 / 2, ...getStyles2("svg"), children: [
...
function SimpleGridMediaVariables({
  ...
  return (0, import_jsx_runtime287.jsx)(InlineStyles, { styles: baseStyles, media, selector });
}
...
function SimpleGridContainerVariables({
  ...
  return (0, import_jsx_runtime287.jsx)(InlineStyles, { styles: baseStyles, container: media, selector });
}
...
var SimpleGrid = factory((_props, ref) => {
  const props = useProps("SimpleGrid", defaultProps157, _props);
  const {
    classNames,
    className,
    style,
  ...
  if (type === "container") {
    return (0, import_jsx_runtime288.jsxs)(import_jsx_runtime288.Fragment, { children: [
      (0, import_jsx_runtime288.jsx)(SimpleGridContainerVariables, { ...props, selector: `.${responsiveClassName}` }),
      (0, import_jsx_runtime288.jsx)("div", { ...getStyles2("container"), children: (0, import_jsx_runtime288.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others }) })
    ] });
  }
  return (0, import_jsx_runtime288.jsxs)(import_jsx_runtime288.Fragment, { children: [
    (0, import_jsx_runtime288.jsx)(SimpleGridMediaVariables, { ...props, selector: `.${responsiveClassName}` }),
    (0, import_jsx_runtime288.jsx)(Box, { ref, ...getStyles2("root", { className: responsiveClassName }), ...others })
  ] });
});
...
var Skeleton = factory((_props, ref) => {
  const props = useProps("Skeleton", defaultProps158, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime289.jsx)(Box, { ref, ...getStyles2("root"), mod: [{ visible: visible2, animate }, mod], ...others });
});
...
var SliderRoot = (0, import_react385.forwardRef)(
...
var Thumb3 = (0, import_react386.forwardRef)(
  ({
    max: max2,
    min: min2,
    value,
    ...
    const { getStyles: getStyles2 } = useSliderContext();
    const [focused, setFocused] = (0, import_react386.useState)(false);
        ...
        children: [
          ...
          (0, import_jsx_runtime292.jsx)(
            Transition,
            {
              ...
              duration: 0,
              ...labelTransitionProps,
              children: (transitionStyles) => (0, import_jsx_runtime292.jsx)("div", { ...getStyles2("label", { style: transitionStyles }), children: label })
            }
          )
        ]
      }
...
function Marks({ marks, min: min2, max: max2, disabled, value, offset: offset4, inverted }) {
  ...
  const items = marks.map((mark, index5) => (0, import_react387.createElement)(
    Box,
    {
    ...
    mark.label && (0, import_jsx_runtime293.jsx)("div", { ...getStyles2("markLabel"), children: mark.label })
  ));
  return (0, import_jsx_runtime293.jsx)("div", { children: items });
}
...
function Track({
  ...
  const { getStyles: getStyles2 } = useSliderContext();
  return (0, import_jsx_runtime294.jsx)(Box, { ...getStyles2("trackContainer"), mod: { disabled }, ...containerProps, children: (0, import_jsx_runtime294.jsxs)(Box, { ...getStyles2("track"), mod: { inverted, disabled }, children: [
    ...
    children,
    (0, import_jsx_runtime294.jsx)(Marks, { ...others, offset: marksOffset, disabled, inverted })
  ] }) });
}
...
var Slider = factory((_props, ref) => {
  const props = useProps("Slider", defaultProps159, _props);
  const {
    classNames,
    styles,
    value,
  ...
  const { dir } = useDirection();
  const [hovered, setHovered] = (0, import_react389.useState)(false);
  const [_value, setValue] = useUncontrolled({
  ...
  const valueRef = (0, import_react389.useRef)(_value);
  const root = (0, import_react389.useRef)();
  const thumb = (0, import_react389.useRef)();
  const position = getPosition({ value: _value, min: min2, max: max2 });
  const scaledValue = scale(_value);
  const _label = typeof label === "function" ? label(scaledValue) : label;
  const precision = _precision ?? getPrecision(step);
  const handleChange = (0, import_react389.useCallback)(
    ({ x }) => {
      if (!disabled) {
  ...
  return (0, import_jsx_runtime295.jsx)(SliderProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime295.jsxs)(
    SliderRoot,
    {
      ...others,
      ...
      children: [
        (0, import_jsx_runtime295.jsx)(
          Track,
          {
            ...
            children: (0, import_jsx_runtime295.jsx)(
              Thumb3,
              {
                max: max2,
                min: min2,
        ...
        (0, import_jsx_runtime295.jsx)("input", { type: "hidden", name, value: scaledValue, ...hiddenInputProps })
      ]
    }
  ) });
});
...
var RangeSlider = factory((_props, ref) => {
  const props = useProps("RangeSlider", defaultProps160, _props);
  const {
    classNames,
    styles,
    value,
  ...
  const { dir } = useDirection();
  const [focused, setFocused] = (0, import_react390.useState)(-1);
  ...
  const thumbs = (0, import_react390.useRef)([]);
  const thumbIndex = (0, import_react390.useRef)(void 0);
  const positions = [
  ...
  return (0, import_jsx_runtime296.jsx)(SliderProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime296.jsxs)(SliderRoot, { ...others, size: size4, ref, disabled, children: [
    ...
    (0, import_jsx_runtime296.jsx)("input", { type: "hidden", name: `${name}_from`, value: _value[0], ...hiddenInputProps }),
    (0, import_jsx_runtime296.jsx)("input", { type: "hidden", name: `${name}_to`, value: _value[1], ...hiddenInputProps })
  ] }) });
});
...
var Space = factory((props, ref) => {
  const { w, h, miw, mih, ...others } = useProps("Space", defaultProps161, props);
  return (0, import_jsx_runtime297.jsx)(Box, { ref, ...others, w, miw: miw ?? w, h, mih: mih ?? h });
});
...
var Spoiler = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime298.jsxs)(
    Box,
    {
      ...
      ...others,
      children: [
        spoiler && (0, import_jsx_runtime298.jsx)(
          Anchor,
          {
            component: "button",
            type: "button",
        ...
        (0, import_jsx_runtime298.jsx)(
          "div",
          {
            ...
            role: "region",
            id: regionId,
            children: (0, import_jsx_runtime298.jsx)("div", { ref: contentRef, children })
          }
        )
      ]
    }
...
var varsResolver78 = createVarsResolver((_, { gap, align, justify }) => ({
  root: {
...
var Stack = factory((_props, ref) => {
  const props = useProps("Stack", defaultProps163, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime299.jsx)(Box, { ref, ...getStyles2("root"), variant, ...others });
});
...
var getStepFragment = (Fragment30, step) => {
  if (typeof Fragment30 === "function") {
    return (0, import_jsx_runtime301.jsx)(Fragment30, { step: step || 0 });
  }
  return Fragment30;
};
var defaultProps164 = {
...
var StepperStep = factory((props, ref) => {
  const {
    ...
    mod,
    ...others
  } = useProps("StepperStep", defaultProps164, props);
  ...
  return (0, import_jsx_runtime301.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        withIcon && (0, import_jsx_runtime301.jsxs)("span", { ...ctx.getStyles("stepWrapper", stylesApi), children: [
          (0, import_jsx_runtime301.jsxs)("span", { ...ctx.getStyles("stepIcon", stylesApi), ...dataAttributes, children: [
            (0, import_jsx_runtime301.jsx)(Transition, { mounted: state === "stepCompleted", transition: "pop", duration: 200, children: (transitionStyles) => (0, import_jsx_runtime301.jsx)(
              "span",
              {
                ...ctx.getStyles("stepCompletedIcon", { style: transitionStyles, ...stylesApi }),
                children: loading ? (0, import_jsx_runtime301.jsx)(
                  Loader,
                  {
                    color: "var(--mantine-color-white)",
                ...
                ) : getStepFragment(completedIcon, step) || (0, import_jsx_runtime301.jsx)(CheckIcon, { size: "60%" })
              }
            ) }),
            state !== "stepCompleted" ? loading ? (0, import_jsx_runtime301.jsx)(
              Loader,
              {
                ...ctx.getStyles("stepLoader", stylesApi),
                size: "calc(var(--stepper-icon-size) / 2)",
          ...
          orientation === "vertical" && (0, import_jsx_runtime301.jsx)(
            "span",
            {
        ...
        (label || description) && (0, import_jsx_runtime301.jsxs)(
          "span",
          {
            ...
            children: [
              label && (0, import_jsx_runtime301.jsx)("span", { ...ctx.getStyles("stepLabel", stylesApi), children: getStepFragment(label, step) }),
              description && (0, import_jsx_runtime301.jsx)("span", { ...ctx.getStyles("stepDescription", stylesApi), children: getStepFragment(description, step) })
            ]
          }
        )
      ]
...
var Stepper = factory((_props, ref) => {
  var _a, _b, _c;
  const props = useProps("Stepper", defaultProps165, _props);
  const {
    classNames,
    className,
    style,
  ...
  const convertedChildren = import_react396.Children.toArray(children);
  ...
  const items = _children.reduce((acc, item, index5) => {
    ...
    acc.push(
      (0, import_react396.cloneElement)(item, {
    ...
    if (orientation === "horizontal" && index5 !== _children.length - 1) {
      acc.push(
        (0, import_react396.createElement)(
          "div",
          {
  ...
  return (0, import_jsx_runtime302.jsx)(StepperProvider, { value: { getStyles: getStyles2, orientation, iconPosition }, children: (0, import_jsx_runtime302.jsxs)(Box, { ...getStyles2("root"), ref, size: size4, ...others, children: [
    ...
    content && (0, import_jsx_runtime302.jsx)("div", { ...getStyles2("content"), children: content })
  ] }) });
});
...
var SwitchGroupContext = (0, import_react397.createContext)(null);
var SwitchGroupProvider = SwitchGroupContext.Provider;
var useSwitchGroupContext = () => (0, import_react397.useContext)(SwitchGroupContext);
...
var SwitchGroup = factory((props, ref) => {
  const { value, defaultValue, onChange, size: size4, wrapperProps, children, readOnly, ...others } = useProps("SwitchGroup", defaultProps166, props);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [],
  ...
  return (0, import_jsx_runtime303.jsx)(SwitchGroupProvider, { value: { value: _value, onChange: handleChange, size: size4 }, children: (0, import_jsx_runtime303.jsx)(
    Input.Wrapper,
    {
      size: size4,
      ref,
      ...
      children: (0, import_jsx_runtime303.jsx)(InputsGroupFieldset, { role: "group", children })
    }
  ) });
});
...
var varsResolver80 = createVarsResolver((theme, { radius, color, size: size4 }) => ({
  root: {
...
var Switch = factory((_props, ref) => {
  const props = useProps("Switch", defaultProps167, _props);
  const {
    classNames,
    className,
    style,
      ...
      children: [
        ...
        (0, import_jsx_runtime304.jsxs)(
          Box,
          {
            ...
            ...getStyles2("track"),
            children: [
              (0, import_jsx_runtime304.jsx)(Box, { component: "span", mod: "reduce-motion", ...getStyles2("thumb"), children: thumbIcon }),
              (0, import_jsx_runtime304.jsx)("span", { ...getStyles2("trackLabel"), children: _checked ? onLabel : offLabel })
            ]
          }
        )
      ]
...
function TableDataRenderer({ data }) {
  return (0, import_jsx_runtime307.jsxs)(import_jsx_runtime307.Fragment, { children: [
    data.caption && (0, import_jsx_runtime307.jsx)(TableCaption, { children: data.caption }),
    data.head && (0, import_jsx_runtime307.jsx)(TableThead, { children: (0, import_jsx_runtime307.jsx)(TableTr, { children: data.head.map((item, index5) => (0, import_jsx_runtime307.jsx)(TableTh, { children: item }, index5)) }) }),
    data.body && (0, import_jsx_runtime307.jsx)(TableTbody, { children: data.body.map((row, rowIndex) => (0, import_jsx_runtime307.jsx)(TableTr, { children: row.map((item, index5) => (0, import_jsx_runtime307.jsx)(TableTd, { children: item }, index5)) }, rowIndex)) }),
    data.foot && (0, import_jsx_runtime307.jsx)(TableTfoot, { children: (0, import_jsx_runtime307.jsx)(TableTr, { children: data.foot.map((item, index5) => (0, import_jsx_runtime307.jsx)(TableTh, { children: item }, index5)) }) })
  ] });
}
...
var varsResolver81 = createVarsResolver((_, { minWidth, type }) => ({
  scrollContainer: {
...
var TableScrollContainer = factory((_props, ref) => {
  const props = useProps("TableScrollContainer", defaultProps168, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime308.jsx)(
    Box,
    {
      ...
      ...others,
      children: (0, import_jsx_runtime308.jsx)("div", { ...getStyles2("scrollContainerInner"), children })
    }
  );
});
...
var Table = factory((_props, ref) => {
  const props = useProps("Table", defaultProps169, _props);
  const {
    classNames,
    className,
    style,
    ...
    TableProvider,
    {
      ...
      children: (0, import_jsx_runtime309.jsx)(
        Box,
        {
          ...
          ...getStyles2("table"),
          ...others,
          children: children || !!data && (0, import_jsx_runtime309.jsx)(TableDataRenderer, { data })
        }
      )
    }
  );
...
var TabsList = factory((_props, ref) => {
  const props = useProps("TabsList", defaultProps170, _props);
...
var TabsPanel = factory((_props, ref) => {
  const props = useProps("TabsPanel", defaultProps171, _props);
...
var TabsTab = factory((_props, ref) => {
  const props = useProps("TabsTab", defaultProps172, _props);
  const {
    className,
    children,
    rightSection,
  ...
  return (0, import_jsx_runtime313.jsxs)(
    UnstyledButton,
    {
      ...
      children: [
        leftSection && (0, import_jsx_runtime313.jsx)("span", { ...ctx.getStyles("tabSection", stylesApiProps), "data-position": "left", children: leftSection }),
        children && (0, import_jsx_runtime313.jsx)("span", { ...ctx.getStyles("tabLabel", stylesApiProps), children }),
        rightSection && (0, import_jsx_runtime313.jsx)("span", { ...ctx.getStyles("tabSection", stylesApiProps), "data-position": "right", children: rightSection })
      ]
    }
  );
});
...
var varsResolver83 = createVarsResolver((theme, { radius, color, autoContrast }) => ({
  root: {
...
var Tabs = factory((_props, ref) => {
  const props = useProps("Tabs", defaultProps173, _props);
  const {
    defaultValue,
    value,
    onChange,
  ...
  return (0, import_jsx_runtime314.jsx)(
    TabsProvider,
    {
      ...
      children: (0, import_jsx_runtime314.jsx)(
        Box,
        {
          ref,
          id: uid,
...
var TagsInput = factory((_props, ref) => {
  const props = useProps("TagsInput", defaultProps174, _props);
  const {
    classNames,
    className,
    style,
  ...
  const parsedData = getParsedComboboxData(data);
  const optionsLockup = getOptionsLockup(parsedData);
  const inputRef = (0, import_react410.useRef)(null);
  ...
  const values2 = _value.map((item, index5) => (0, import_jsx_runtime316.jsx)(
    Pill,
    {
  ...
  const clearButton = clearable && _value.length > 0 && !disabled && !readOnly && (0, import_jsx_runtime316.jsx)(
    Combobox.ClearButton,
    {
      size: size4,
      ...clearButtonProps,
  ...
  return (0, import_jsx_runtime316.jsxs)(import_jsx_runtime316.Fragment, { children: [
    (0, import_jsx_runtime316.jsxs)(
      Combobox,
      {
        ...
        ...comboboxProps,
        children: [
          (0, import_jsx_runtime316.jsx)(Combobox.DropdownTarget, { children: (0, import_jsx_runtime316.jsx)(
            PillsInput,
            {
              ...styleProps,
              __staticSelector: "TagsInput",
              ...
              id: _id,
              mod,
              children: (0, import_jsx_runtime316.jsxs)(Pill.Group, { disabled, unstyled, ...getStyles2("pillsList"), children: [
                values2,
                (0, import_jsx_runtime316.jsx)(Combobox.EventsTarget, { autoComplete, children: (0, import_jsx_runtime316.jsx)(
                  PillsInput.Field,
                  {
                    ...rest,
                    ref: _ref,
...
var TextInput = factory((props, ref) => {
  const _props = useProps("TextInput", defaultProps175, props);
  return (0, import_jsx_runtime317.jsx)(InputBase, { component: "input", ref, ..._props, __staticSelector: "TextInput" });
});
...
var ThemeIcon = factory((_props, ref) => {
  const props = useProps("ThemeIcon", defaultProps176, _props);
  ...
  return (0, import_jsx_runtime318.jsx)(Box, { ref, ...getStyles2("root"), ...others });
});
...
var TimelineItem = factory((_props, ref) => {
  const props = useProps("TimelineItem", defaultProps177, _props);
  const {
    classNames,
    className,
    style,
  ...
  return (0, import_jsx_runtime320.jsxs)(
    Box,
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime320.jsxs)("div", { ...ctx.getStyles("itemBody", stylesApiProps), children: [
          title && (0, import_jsx_runtime320.jsx)("div", { ...ctx.getStyles("itemTitle", stylesApiProps), children: title }),
          (0, import_jsx_runtime320.jsx)("div", { ...ctx.getStyles("itemContent", stylesApiProps), children })
        ] })
      ]
    }
  );
...
var Timeline = factory((_props, ref) => {
  const props = useProps("Timeline", defaultProps178, _props);
  const {
    classNames,
    className,
    style,
  ...
  const _children = import_react415.Children.toArray(children);
  const items = _children.map(
    (item, index5) => {
      var _a, _b;
      return (0, import_react415.cloneElement)(item, {
        unstyled,
        __align: align,
  ...
  return (0, import_jsx_runtime321.jsx)(TimelineProvider, { value: { getStyles: getStyles2 }, children: (0, import_jsx_runtime321.jsx)(Box, { ...getStyles2("root"), mod: [{ align }, mod], ref, ...others, children: items }) });
});
...
var varsResolver86 = createVarsResolver((_, { order, size: size4, lineClamp, textWrap }) => {
...
var Title = factory((_props, ref) => {
  const props = useProps("Title", defaultProps179, _props);
  const {
    classNames,
    className,
    style,
...
function TreeNode({
  ...
  const ref = (0, import_react418.useRef)(null);
  const nested = (node.children || []).map((child) => (0, import_jsx_runtime324.jsx)(
    TreeNode,
    {
      node: child,
      flatValues,
  ...
  return (0, import_jsx_runtime324.jsxs)(
    "li",
    {
      ...getStyles2("node", {
      ...
      children: [
        typeof renderNode === "function" ? renderNode({
          ...
          elementProps
        }) : (0, import_jsx_runtime324.jsx)("div", { ...elementProps, children: node.label }),
        controller.expandedState[node.value] && nested.length > 0 && (0, import_jsx_runtime324.jsx)("ul", { role: "group", ...getStyles2("subtree"), "data-level": level, children: nested })
      ]
    }
  );
}
...
function useTree({
  ...
  const [data, setData] = (0, import_react421.useState)([]);
  const [expandedState, setExpandedState] = (0, import_react421.useState)(initialExpandedState);
  const [selectedState, setSelectedState] = (0, import_react421.useState)(initialSelectedState);
  const [checkedState, setCheckedState] = (0, import_react421.useState)(initialCheckedState);
  const [anchorNode, setAnchorNode] = (0, import_react421.useState)(null);
  const [hoveredNode, setHoveredNode] = (0, import_react421.useState)(null);
  const initialize = (0, import_react421.useCallback)(
    (_data) => {
  ...
  const toggleExpanded = (0, import_react421.useCallback)(
    (value) => {
  ...
  const collapse = (0, import_react421.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expand = (0, import_react421.useCallback)(
    (value) => {
      setExpandedState((current) => {
  ...
  const expandAllNodes = (0, import_react421.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
  ...
  const collapseAllNodes = (0, import_react421.useCallback)(() => {
    setExpandedState((current) => {
      const next = { ...current };
      Object.keys(next).forEach((key) => {
        next[key] = false;
  ...
  const toggleSelected = (0, import_react421.useCallback)(
  ...
  const select = (0, import_react421.useCallback)((value) => {
    setAnchorNode(value);
    setSelectedState(
      (current) => multiple ? current.includes(value) ? current : [...current, value] : [value]
    );
  }, []);
  const deselect = (0, import_react421.useCallback)((value) => {
    anchorNode === value && setAnchorNode(null);
    setSelectedState((current) => current.filter((item) => item !== value));
  }, []);
  const clearSelected = (0, import_react421.useCallback)(() => {
    setSelectedState([]);
    setAnchorNode(null);
  }, []);
  const checkNode = (0, import_react421.useCallback)(
    (value) => {
  ...
  const uncheckNode = (0, import_react421.useCallback)(
    (value) => {
      const checkedNodes = getChildrenNodesValues(value, data);
  ...
  const checkAllNodes = (0, import_react421.useCallback)(() => {
    setCheckedState(() => getAllChildrenNodes(data));
  }, [data]);
  const uncheckAllNodes = (0, import_react421.useCallback)(() => {
    setCheckedState([]);
  }, []);
...
var varsResolver87 = createVarsResolver((_theme, { levelOffset }) => ({
  root: {
    "--level-offset": getSpacing(levelOffset)
  }
}));
var Tree = factory((_props, ref) => {
  const props = useProps("Tree", defaultProps180, _props);
  const {
    classNames,
    className,
    style,
  ...
  const flatValues = (0, import_react422.useMemo)(() => getFlatValues(data), [data]);
  (0, import_react422.useEffect)(() => {
    controller.initialize(data);
  }, [data]);
  const nodes = data.map((node, index5) => (0, import_jsx_runtime327.jsx)(
    TreeNode,
    {
      node,
      getStyles: getStyles2,
...
var TypographyStylesProvider = factory((_props, ref) => {
  const props = useProps("TypographyStylesProvider", defaultProps181, _props);
